...
enum opt_code
{
  ...
  OPT__param_parloops_chunk_size_ = 264,     /* --param=parloops-chunk-size= */
  OPT__param_parloops_min_per_thread_ = 265, /* --param=parloops-min-per-thread= */
  OPT__param_parloops_schedule_ = 266,       /* --param=parloops-schedule= */
  OPT__param_partial_inlining_entry_probability_ = 267,/* --param=partial-inlining-entry-probability= */
  OPT__param_predictable_branch_outcome_ = 268,/* --param=predictable-branch-outcome= */
  OPT__param_prefetch_dynamic_strides_ = 269,/* --param=prefetch-dynamic-strides= */
  OPT__param_prefetch_latency_ = 270,        /* --param=prefetch-latency= */
  OPT__param_prefetch_min_insn_to_mem_ratio_ = 271,/* --param=prefetch-min-insn-to-mem-ratio= */
  OPT__param_prefetch_minimum_stride_ = 272, /* --param=prefetch-minimum-stride= */
  OPT__param_profile_func_internal_id_ = 273,/* --param=profile-func-internal-id= */
  OPT__param_rpo_vn_max_loop_depth_ = 274,   /* --param=rpo-vn-max-loop-depth= */
  OPT__param_sccvn_max_alias_queries_per_access_ = 275,/* --param=sccvn-max-alias-queries-per-access= */
  OPT__param_scev_max_expr_complexity_ = 276,/* --param=scev-max-expr-complexity= */
  OPT__param_scev_max_expr_size_ = 277,      /* --param=scev-max-expr-size= */
  OPT__param_sched_autopref_queue_depth_ = 278,/* --param=sched-autopref-queue-depth= */
  OPT__param_sched_mem_true_dep_cost_ = 279, /* --param=sched-mem-true-dep-cost= */
  OPT__param_sched_pressure_algorithm_ = 280,/* --param=sched-pressure-algorithm= */
  OPT__param_sched_spec_prob_cutoff_ = 281,  /* --param=sched-spec-prob-cutoff= */
  OPT__param_sched_state_edge_prob_cutoff_ = 282,/* --param=sched-state-edge-prob-cutoff= */
  OPT__param_selsched_insns_to_rename_ = 283,/* --param=selsched-insns-to-rename= */
  OPT__param_selsched_max_lookahead_ = 284,  /* --param=selsched-max-lookahead= */
  OPT__param_selsched_max_sched_times_ = 285,/* --param=selsched-max-sched-times= */
  OPT__param_simultaneous_prefetches_ = 286, /* --param=simultaneous-prefetches= */
  OPT__param_sink_frequency_threshold_ = 287,/* --param=sink-frequency-threshold= */
  OPT__param_sms_dfa_history_ = 288,         /* --param=sms-dfa-history= */
  OPT__param_sms_loop_average_count_threshold_ = 289,/* --param=sms-loop-average-count-threshold= */
  OPT__param_sms_max_ii_factor_ = 290,       /* --param=sms-max-ii-factor= */
  OPT__param_sms_min_sc_ = 291,              /* --param=sms-min-sc= */
  OPT__param_sra_max_propagations_ = 292,    /* --param=sra-max-propagations= */
  OPT__param_sra_max_scalarization_size_Osize_ = 293,/* --param=sra-max-scalarization-size-Osize= */
  OPT__param_sra_max_scalarization_size_Ospeed_ = 294,/* --param=sra-max-scalarization-size-Ospeed= */
  OPT__param_ssa_name_def_chain_limit_ = 295,/* --param=ssa-name-def-chain-limit= */
  OPT__param_ssp_buffer_size_ = 296,         /* --param=ssp-buffer-size= */
  OPT__param_stack_clash_protection_guard_size_ = 297,/* --param=stack-clash-protection-guard-size= */
  OPT__param_stack_clash_protection_probe_interval_ = 298,/* --param=stack-clash-protection-probe-interval= */
  OPT__param_store_merging_allow_unaligned_ = 299,/* --param=store-merging-allow-unaligned= */
  OPT__param_store_merging_max_size_ = 300,  /* --param=store-merging-max-size= */
  OPT__param_switch_conversion_max_branch_ratio_ = 301,/* --param=switch-conversion-max-branch-ratio= */
  OPT__param_tm_max_aggregate_size_ = 302,   /* --param=tm-max-aggregate-size= */
  OPT__param_tracer_dynamic_coverage_feedback_ = 303,/* --param=tracer-dynamic-coverage-feedback= */
  OPT__param_tracer_dynamic_coverage_ = 304, /* --param=tracer-dynamic-coverage= */
  OPT__param_tracer_max_code_growth_ = 305,  /* --param=tracer-max-code-growth= */
  OPT__param_tracer_min_branch_probability_feedback_ = 306,/* --param=tracer-min-branch-probability-feedback= */
  OPT__param_tracer_min_branch_probability_ = 307,/* --param=tracer-min-branch-probability= */
  OPT__param_tracer_min_branch_ratio_ = 308, /* --param=tracer-min-branch-ratio= */
  OPT__param_tree_reassoc_width_ = 309,      /* --param=tree-reassoc-width= */
  OPT__param_tsan_distinguish_volatile_ = 310,/* --param=tsan-distinguish-volatile= */
  OPT__param_tsan_instrument_func_entry_exit_ = 311,/* --param=tsan-instrument-func-entry-exit= */
  OPT__param_uninit_control_dep_attempts_ = 312,/* --param=uninit-control-dep-attempts= */
  OPT__param_uninlined_function_insns_ = 313,/* --param=uninlined-function-insns= */
  OPT__param_uninlined_function_time_ = 314, /* --param=uninlined-function-time= */
  OPT__param_uninlined_thunk_insns_ = 315,   /* --param=uninlined-thunk-insns= */
  OPT__param_uninlined_thunk_time_ = 316,    /* --param=uninlined-thunk-time= */
  OPT__param_unlikely_bb_count_fraction_ = 317,/* --param=unlikely-bb-count-fraction= */
  OPT__param_unroll_jam_max_unroll_ = 318,   /* --param=unroll-jam-max-unroll= */
  OPT__param_unroll_jam_min_percent_ = 319,  /* --param=unroll-jam-min-percent= */
  OPT__param_use_after_scope_direct_emission_threshold_ = 320,/* --param=use-after-scope-direct-emission-threshold= */
  OPT__param_use_canonical_types_ = 321,     /* --param=use-canonical-types= */
  OPT__param_vect_epilogues_nomask_ = 322,   /* --param=vect-epilogues-nomask= */
  OPT__param_vect_max_peeling_for_alignment_ = 323,/* --param=vect-max-peeling-for-alignment= */
  OPT__param_vect_max_version_for_alias_checks_ = 324,/* --param=vect-max-version-for-alias-checks= */
  OPT__param_vect_max_version_for_alignment_checks_ = 325,/* --param=vect-max-version-for-alignment-checks= */
  OPT__param_vect_partial_vector_usage_ = 326,/* --param=vect-partial-vector-usage= */
  /* OPT__pass_exit_codes = 327, */          /* --pass-exit-codes */
  /* OPT__pedantic = 328, */                 /* --pedantic */
  /* OPT__pedantic_errors = 329, */          /* --pedantic-errors */
  /* OPT__pie = 330, */                      /* --pie */
  /* OPT__pipe = 331, */                     /* --pipe */
  /* OPT__prefix = 332, */                   /* --prefix */
  /* OPT__prefix_ = 333, */                  /* --prefix= */
  /* OPT__preprocess = 334, */               /* --preprocess */
  /* OPT__print_file_name = 335, */          /* --print-file-name */
  /* OPT__print_file_name_ = 336, */         /* --print-file-name= */
  /* OPT__print_libgcc_file_name = 337, */   /* --print-libgcc-file-name */
  /* OPT__print_missing_file_dependencies = 338, *//* --print-missing-file-dependencies */
  /* OPT__print_multi_directory = 339, */    /* --print-multi-directory */
  /* OPT__print_multi_lib = 340, */          /* --print-multi-lib */
  /* OPT__print_multi_os_directory = 341, */ /* --print-multi-os-directory */
  /* OPT__print_multiarch = 342, */          /* --print-multiarch */
  /* OPT__print_prog_name = 343, */          /* --print-prog-name */
  /* OPT__print_prog_name_ = 344, */         /* --print-prog-name= */
  /* OPT__print_search_dirs = 345, */        /* --print-search-dirs */
  /* OPT__print_sysroot = 346, */            /* --print-sysroot */
  /* OPT__print_sysroot_headers_suffix = 347, *//* --print-sysroot-headers-suffix */
  /* OPT__profile = 348, */                  /* --profile */
  /* OPT__save_temps = 349, */               /* --save-temps */
  /* OPT__shared = 350, */                   /* --shared */
  /* OPT__specs = 351, */                    /* --specs */
  /* OPT__specs_ = 352, */                   /* --specs= */
  /* OPT__static = 353, */                   /* --static */
  /* OPT__static_pie = 354, */               /* --static-pie */
  /* OPT__symbolic = 355, */                 /* --symbolic */
  /* OPT__sysroot = 356, */                  /* --sysroot */
  OPT__sysroot_ = 357,                       /* --sysroot= */
  OPT__target_help = 358,                    /* --target-help */
  /* OPT__time = 359, */                     /* --time */
  /* OPT__trace_includes = 360, */           /* --trace-includes */
  /* OPT__traditional = 361, */              /* --traditional */
  /* OPT__traditional_cpp = 362, */          /* --traditional-cpp */
  /* OPT__trigraphs = 363, */                /* --trigraphs */
  /* OPT__undefine_macro = 364, */           /* --undefine-macro */
  /* OPT__undefine_macro_ = 365, */          /* --undefine-macro= */
  /* OPT__user_dependencies = 366, */        /* --user-dependencies */
  /* OPT__verbose = 367, */                  /* --verbose */
  OPT__version = 368,                        /* --version */
  /* OPT__write_dependencies = 369, */       /* --write-dependencies */
  /* OPT__write_user_dependencies = 370, */  /* --write-user-dependencies */
  OPT_A = 371,                               /* -A */
  OPT_B = 372,                               /* -B */
  OPT_C = 373,                               /* -C */
  OPT_CC = 374,                              /* -CC */
  ...
  OPT_MQ = 391,                              /* -MQ */
  OPT_MT = 392,                              /* -MT */
  OPT_Mmodules = 393,                        /* -Mmodules */
  OPT_Mno_modules = 394,                     /* -Mno-modules */
  OPT_N = 395,                               /* -N */
  OPT_O = 396,                               /* -O */
  OPT_Ofast = 397,                           /* -Ofast */
  OPT_Og = 398,                              /* -Og */
  ...
  OPT_Tbss_ = 408,                           /* -Tbss= */
  OPT_Tdata = 409,                           /* -Tdata */
  OPT_Tdata_ = 410,                          /* -Tdata= */
  OPT_Ttext = 411,                           /* -Ttext */
  OPT_Ttext_ = 412,                          /* -Ttext= */
  OPT_U = 413,                               /* -U */
  /* OPT_W = 414, */                         /* -W */
  OPT_WNSObject_attribute = 415,             /* -WNSObject-attribute */
  OPT_Wa_ = 416,                             /* -Wa, */
  OPT_Wabi = 417,                            /* -Wabi */
  OPT_Wabi_tag = 418,                        /* -Wabi-tag */
  OPT_Wabi_ = 419,                           /* -Wabi= */
  OPT_Wabsolute_value = 420,                 /* -Wabsolute-value */
  OPT_Waddress = 421,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 422,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 423,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 424,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 425,                       /* -Waliasing */
  OPT_Walign_commons = 426,                  /* -Walign-commons */
  /* OPT_Waligned_new = 427, */              /* -Waligned-new */
  OPT_Waligned_new_ = 428,                   /* -Waligned-new= */
  OPT_Wall = 429,                            /* -Wall */
  OPT_Walloc_size_larger_than_ = 430,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 431,                     /* -Walloc-zero */
  OPT_Walloca = 432,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 433,            /* -Walloca-larger-than= */
  OPT_Wampersand = 434,                      /* -Wampersand */
  OPT_Wanalyzer_double_fclose = 435,         /* -Wanalyzer-double-fclose */
  OPT_Wanalyzer_double_free = 436,           /* -Wanalyzer-double-free */
  OPT_Wanalyzer_exposure_through_output_file = 437,/* -Wanalyzer-exposure-through-output-file */
  OPT_Wanalyzer_file_leak = 438,             /* -Wanalyzer-file-leak */
  OPT_Wanalyzer_free_of_non_heap = 439,      /* -Wanalyzer-free-of-non-heap */
  OPT_Wanalyzer_malloc_leak = 440,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_mismatching_deallocation = 441,/* -Wanalyzer-mismatching-deallocation */
  OPT_Wanalyzer_null_argument = 442,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 443,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_possible_null_argument = 444,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 445,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_shift_count_negative = 446,  /* -Wanalyzer-shift-count-negative */
  OPT_Wanalyzer_shift_count_overflow = 447,  /* -Wanalyzer-shift-count-overflow */
  OPT_Wanalyzer_stale_setjmp_buffer = 448,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_tainted_array_index = 449,   /* -Wanalyzer-tainted-array-index */
  OPT_Wanalyzer_too_complex = 450,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 451,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 452,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 453,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_write_to_const = 454,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 455,/* -Wanalyzer-write-to-string-literal */
  OPT_Wargument_mismatch = 456,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 457,               /* -Warith-conversion */
  OPT_Warray_bounds = 458,                   /* -Warray-bounds */
  OPT_Warray_bounds_ = 459,                  /* -Warray-bounds= */
  /* OPT_Warray_parameter = 460, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 461,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 462,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 463,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 464, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 465,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 466,              /* -Wattribute-warning */
  OPT_Wattributes = 467,                     /* -Wattributes */
  OPT_Wbad_function_cast = 468,              /* -Wbad-function-cast */
  OPT_Wbool_compare = 469,                   /* -Wbool-compare */
  OPT_Wbool_operation = 470,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 471,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 472,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 473,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 474, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 475,                   /* -Wc++11-compat */
  OPT_Wc__14_compat = 476,                   /* -Wc++14-compat */
  OPT_Wc__17_compat = 477,                   /* -Wc++17-compat */
  /* OPT_Wc__1z_compat = 478, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 479,                   /* -Wc++20-compat */
  /* OPT_Wc__2a_compat = 480, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 481,                 /* -Wc-binding-type */
  OPT_Wc11_c2x_compat = 482,                 /* -Wc11-c2x-compat */
  OPT_Wc90_c99_compat = 483,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 484,                 /* -Wc99-c11-compat */
  OPT_Wcannot_profile = 485,                 /* -Wcannot-profile */
  OPT_Wcast_align = 486,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 487,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 488,             /* -Wcast-function-type */
  OPT_Wcast_qual = 489,                      /* -Wcast-qual */
  OPT_Wcast_result = 490,                    /* -Wcast-result */
  /* OPT_Wcatch_value = 491, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 492,                   /* -Wcatch-value= */
  OPT_Wchar_subscripts = 493,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 494,           /* -Wcharacter-truncation */
  OPT_Wchkp = 495,                           /* -Wchkp */
  OPT_Wclass_conversion = 496,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 497,                /* -Wclass-memaccess */
  OPT_Wclobbered = 498,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 499,                /* -Wcomma-subscript */
  OPT_Wcomment = 500,                        /* -Wcomment */
  /* OPT_Wcomments = 501, */                 /* -Wcomments */
  OPT_Wcompare_reals = 502,                  /* -Wcompare-reals */
  OPT_Wconditionally_supported = 503,        /* -Wconditionally-supported */
  OPT_Wconversion = 504,                     /* -Wconversion */
  OPT_Wconversion_extra = 505,               /* -Wconversion-extra */
  OPT_Wconversion_null = 506,                /* -Wconversion-null */
  OPT_Wcoverage_mismatch = 507,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 508,                            /* -Wcpp */
  OPT_Wctad_maybe_unsupported = 509,         /* -Wctad-maybe-unsupported */
  OPT_Wctor_dtor_privacy = 510,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 511,                  /* -Wdangling-else */
  OPT_Wdate_time = 512,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 513,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 514,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 515,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 516,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 517,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 518,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 519,        /* -Wdeprecated-declarations */
  OPT_Wdeprecated_enum_enum_conversion = 520,/* -Wdeprecated-enum-enum-conversion */
  OPT_Wdeprecated_enum_float_conversion = 521,/* -Wdeprecated-enum-float-conversion */
  OPT_Wdesignated_init = 522,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 523,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 524,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 525,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 526,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 527,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 528,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 529,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 530,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 531,                /* -Wduplicated-cond */
  OPT_Weffc__ = 532,                         /* -Weffc++ */
  OPT_Wempty_body = 533,                     /* -Wempty-body */
  OPT_Wendif_labels = 534,                   /* -Wendif-labels */
  OPT_Wenum_compare = 535,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 536,                /* -Wenum-conversion */
  OPT_Werror = 537,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 538, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 539,                         /* -Werror= */
  OPT_Wexceptions = 540,                     /* -Wexceptions */
  OPT_Wexpansion_to_defined = 541,           /* -Wexpansion-to-defined */
  OPT_Wextra = 542,                          /* -Wextra */
  OPT_Wextra_semi = 543,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 544,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 545,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 546,                    /* -Wfloat-equal */
  /* OPT_Wformat = 547, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 548,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 549,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 550,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 551,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 552, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 553,               /* -Wformat-overflow= */
  OPT_Wformat_security = 554,                /* -Wformat-security */
  OPT_Wformat_signedness = 555,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 556, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 557,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 558,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 559,             /* -Wformat-zero-length */
  OPT_Wformat_ = 560,                        /* -Wformat= */
  OPT_Wframe_address = 561,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 562,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 563,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 564,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 565,           /* -Wfunction-elimination */
  /* OPT_Whsa = 566, */                      /* -Whsa */
  OPT_Wif_not_aligned = 567,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 568,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 569,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 570,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 571, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 572,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 573,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 574,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 575,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 576,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 577, */                   /* -Wimport */
  OPT_Winaccessible_base = 578,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 579,     /* -Wincompatible-pointer-types */
  OPT_Winherited_variadic_ctor = 580,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 581,             /* -Winit-list-lifetime */
  OPT_Winit_self = 582,                      /* -Winit-self */
  OPT_Winline = 583,                         /* -Winline */
  OPT_Wint_conversion = 584,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 585,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 586,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 587,               /* -Winteger-division */
  OPT_Wintrinsic_shadow = 588,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 589,                 /* -Wintrinsics-std */
  OPT_Winvalid_imported_macros = 590,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 591,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 592,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 593,                    /* -Winvalid-pch */
  OPT_Wjump_misses_init = 594,               /* -Wjump-misses-init */
  OPT_Wl_ = 595,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 596, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 597,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 598,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 599,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 600,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 601,                     /* -Wlogical-op */
  OPT_Wlong_long = 602,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 603,              /* -Wlto-type-mismatch */
  OPT_Wmain = 604,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 605,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 606,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 607,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 608,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 609,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 610,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_tags = 611,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 612,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 613,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 614,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 615,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 616, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 617,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 618, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 619,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 620,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 621,             /* -Wmissing-prototypes */
  OPT_Wmudflap = 622,                        /* -Wmudflap */
  OPT_Wmultichar = 623,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 624,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 625,          /* -Wmultistatement-macros */
  OPT_Wnamespaces = 626,                     /* -Wnamespaces */
  OPT_Wnarrowing = 627,                      /* -Wnarrowing */
  OPT_Wnested_externs = 628,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 629, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 630, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 631, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 632, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 633, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 634, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 635,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 636,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 637,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 638,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 639,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 640,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 641, */               /* -Wnormalized */
  OPT_Wnormalized_ = 642,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 643,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 644,                /* -Wobjc-root-class */
  OPT_Wodr = 645,                            /* -Wodr */
  OPT_Wold_style_cast = 646,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 647,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 648,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 649,                    /* -Wopenmp-simd */
  OPT_Woverflow = 650,                       /* -Woverflow */
  OPT_Woverlength_strings = 651,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 652,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 653,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 654,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 655,            /* -Woverwrite-recursive */
  OPT_Wp_ = 656,                             /* -Wp, */
  OPT_Wpacked = 657,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 658,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 659,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 660,                         /* -Wpadded */
  OPT_Wparentheses = 661,                    /* -Wparentheses */
  OPT_Wpedantic = 662,                       /* -Wpedantic */
  OPT_Wpessimizing_move = 663,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 664, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 665,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 666,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 667,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 668,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 669,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 670,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 671,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 672,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 673,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 674,                       /* -Wprotocol */
  OPT_Wpsabi = 675,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 676,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 677,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 678,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 679,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 680,                /* -Wredundant-decls */
  OPT_Wredundant_move = 681,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 682,                 /* -Wredundant-tags */
  OPT_Wregister = 683,                       /* -Wregister */
  OPT_Wreorder = 684,                        /* -Wreorder */
  OPT_Wrestrict = 685,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 686,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 687,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 688,           /* -Wscalar-storage-order */
  OPT_Wselector = 689,                       /* -Wselector */
  OPT_Wsequence_point = 690,                 /* -Wsequence-point */
  OPT_Wshadow = 691,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 692, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 693,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 694, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 695,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 696, */            /* -Wshadow=global */
  OPT_Wshadow_local = 697,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 698,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 699,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 700,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 701, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 702,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 703,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 704,                /* -Wsign-conversion */
  OPT_Wsign_promo = 705,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 706,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 707,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 708,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 709,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 710,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 711,                    /* -Wspeculative */
  OPT_Wstack_protector = 712,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 713,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 714,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 715,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 716,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 717,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 718,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 719,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 720,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 721,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 722, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 723,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 724,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 725,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 726,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 727,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 728,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 729,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 730,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 731,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 732,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 733,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 734,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 735,               /* -Wsuggest-override */
  OPT_Wsurprising = 736,                     /* -Wsurprising */
  OPT_Wswitch = 737,                         /* -Wswitch */
  OPT_Wswitch_bool = 738,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 739,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 740,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 741,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 742,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 743,                      /* -Wsync-nand */
  OPT_Wsynth = 744,                          /* -Wsynth */
  OPT_Wsystem_headers = 745,                 /* -Wsystem-headers */
  OPT_Wtabs = 746,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 747,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 748,           /* -Wtautological-compare */
  OPT_Wtemplates = 749,                      /* -Wtemplates */
  OPT_Wterminate = 750,                      /* -Wterminate */
  OPT_Wtraditional = 751,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 752,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 753,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 754,                      /* -Wtrigraphs */
  OPT_Wtsan = 755,                           /* -Wtsan */
  OPT_Wtype_limits = 756,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 757,            /* -Wundeclared-selector */
  OPT_Wundef = 758,                          /* -Wundef */
  OPT_Wundefined_do_loop = 759,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 760,                      /* -Wunderflow */
  OPT_Wuninitialized = 761,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 762,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 763, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 764, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 765,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 766,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 767,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 768,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 769, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 770,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 771,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 772,                /* -Wunused-function */
  OPT_Wunused_label = 773,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 774,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 775,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 776,               /* -Wunused-parameter */
  OPT_Wunused_result = 777,                  /* -Wunused-result */
  OPT_Wunused_value = 778,                   /* -Wunused-value */
  OPT_Wunused_variable = 779,                /* -Wunused-variable */
  OPT_Wuse_without_only = 780,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 781,                   /* -Wuseless-cast */
  OPT_Wvarargs = 782,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 783,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 784,   /* -Wvector-operation-performance */
  OPT_Wvexing_parse = 785,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 786,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 787,            /* -Wvirtual-move-assign */
  OPT_Wvla = 788,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 789,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 790,                  /* -Wvla-parameter */
  OPT_Wvolatile = 791,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 792,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 793,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 794,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 795,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 796,                       /* -Wzerotrip */
  OPT_X = 797,                               /* -X */
  OPT_Xassembler = 798,                      /* -Xassembler */
  OPT_Xf = 799,                              /* -Xf */
  OPT_Xlinker = 800,                         /* -Xlinker */
  OPT_Xpreprocessor = 801,                   /* -Xpreprocessor */
  OPT_Z = 802,                               /* -Z */
  OPT_ansi = 803,                            /* -ansi */
  OPT_aux_info = 804,                        /* -aux-info */
  /* OPT_aux_info_ = 805, */                 /* -aux-info= */
  OPT_c = 806,                               /* -c */
  OPT_callgraph = 807,                       /* -callgraph */
  OPT_coverage = 808,                        /* -coverage */
  OPT_cpp = 809,                             /* -cpp */
  OPT_cpp_ = 810,                            /* -cpp= */
  OPT_d = 811,                               /* -d */
  OPT_debuglib_ = 812,                       /* -debuglib= */
  OPT_defaultlib_ = 813,                     /* -defaultlib= */
  OPT_defined_only = 814,                    /* -defined-only */
  OPT_demangle = 815,                        /* -demangle */
  OPT_dstartfiles = 816,                     /* -dstartfiles */
  OPT_dump_body_ = 817,                      /* -dump-body= */
  OPT_dump_level_ = 818,                     /* -dump-level= */
  OPT_dumpbase = 819,                        /* -dumpbase */
  OPT_dumpbase_ext = 820,                    /* -dumpbase-ext */
  OPT_dumpdir = 821,                         /* -dumpdir */
  OPT_dumpfullversion = 822,                 /* -dumpfullversion */
  OPT_dumpmachine = 823,                     /* -dumpmachine */
  OPT_dumpspecs = 824,                       /* -dumpspecs */
  OPT_dumpversion = 825,                     /* -dumpversion */
  OPT_e = 826,                               /* -e */
  OPT_export_dynamic = 827,                  /* -export-dynamic */
  OPT_fPIC = 828,                            /* -fPIC */
  OPT_fPIE = 829,                            /* -fPIE */
  OPT_fRTS_ = 830,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 831,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 832,                   /* -fabi-version= */
  OPT_faccess_control = 833,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 834,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 835,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 836,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 837,                  /* -falign-commons */
  OPT_falign_functions = 838,                /* -falign-functions */
  OPT_falign_functions_ = 839,               /* -falign-functions= */
  OPT_falign_jumps = 840,                    /* -falign-jumps */
  OPT_falign_jumps_ = 841,                   /* -falign-jumps= */
  OPT_falign_labels = 842,                   /* -falign-labels */
  OPT_falign_labels_ = 843,                  /* -falign-labels= */
  OPT_falign_loops = 844,                    /* -falign-loops */
  OPT_falign_loops_ = 845,                   /* -falign-loops= */
  /* OPT_faligned_new = 846, */              /* -faligned-new */
  OPT_faligned_new_ = 847,                   /* -faligned-new= */
  OPT_fall_instantiations = 848,             /* -fall-instantiations */
  OPT_fall_intrinsics = 849,                 /* -fall-intrinsics */
  OPT_fall_virtual = 850,                    /* -fall-virtual */
  OPT_fallocation_dce = 851,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 852,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 853,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 854,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 855,/* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 856,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 857,         /* -falt-external-templates */
  OPT_fanalyzer = 858,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 859,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 860,              /* -fanalyzer-checker= */
  OPT_fanalyzer_feasibility = 861,           /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 862,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 863,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_state_merge = 864,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 865,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_transitivity = 866,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_verbose_edges = 867,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 868, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 869,            /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 870, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 871, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 872, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 873, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 874,            /* -fasan-shadow-offset= */
  OPT_fasm = 875,                            /* -fasm */
  OPT_fassert = 876,                         /* -fassert */
  OPT_fassociative_math = 877,               /* -fassociative-math */
  OPT_fassume_phsa = 878,                    /* -fassume-phsa */
  OPT_fasynchronous_unwind_tables = 879,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 880,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 881,                   /* -fauto-profile */
  OPT_fauto_profile_ = 882,                  /* -fauto-profile= */
  OPT_fautomatic = 883,                      /* -fautomatic */
  OPT_fbackslash = 884,                      /* -fbackslash */
  OPT_fbacktrace = 885,                      /* -fbacktrace */
  OPT_fbit_tests = 886,                      /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 887,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 888,                   /* -fbounds-check */
  OPT_fbounds_check_ = 889,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 890,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 891,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 892, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 893, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 894, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 895,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 896,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 897,                        /* -fbuiltin */
  OPT_fbuiltin_ = 898,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 899,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 900,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 901,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 902,                    /* -fcall-saved- */
  OPT_fcall_used_ = 903,                     /* -fcall-used- */
  OPT_fcaller_saves = 904,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 905,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 906,                /* -fcallgraph-info= */
  OPT_fcanonical_system_headers = 907,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 908, */            /* -fcf-protection */
  OPT_fcf_protection_ = 909,                 /* -fcf-protection= */
  OPT_fchar8_t = 910,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 911,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 912, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 913,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 914,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 915,                         /* -fcheck= */
  OPT_fchecking = 916,                       /* -fchecking */
  OPT_fchecking_ = 917,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 918,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 919,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 920,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 921,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 922,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 923,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 924,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 925,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 926, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 927,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 928,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 929,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 930, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 931,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 932,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 933,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 934,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 935,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 936, */                 /* -fcilkplus */
  OPT_fcoarray_ = 937,                       /* -fcoarray= */
  OPT_fcode_hoisting = 938,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 939,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 940,                         /* -fcommon */
  OPT_fcompare_debug = 941,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 942,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 943,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 944,                   /* -fcompare-elim */
  OPT_fconcepts = 945,                       /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 946,    /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 947,                    /* -fconcepts-ts */
  OPT_fcond_mismatch = 948,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 949, */           /* -fconserve-space */
  OPT_fconserve_stack = 950,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 951,         /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 952,         /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 953,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 954,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 955,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 956,                       /* -fconvert= */
  OPT_fcoroutines = 957,                     /* -fcoroutines */
  OPT_fcprop_registers = 958,                /* -fcprop-registers */
  OPT_fcray_pointer = 959,                   /* -fcray-pointer */
  OPT_fcrossjumping = 960,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 961,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 962, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 963,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 964,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 965,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 966,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 967,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 968,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 969,                       /* -fdbg-cnt= */
  OPT_fdce = 970,                            /* -fdce */
  OPT_fdebug = 971,                          /* -fdebug */
  OPT_fdebug_aux_vars = 972,                 /* -fdebug-aux-vars */
  OPT_fdebug_cpp = 973,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 974,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 975,            /* -fdebug-types-section */
  OPT_fdebug_ = 976,                         /* -fdebug= */
  OPT_fdec = 977,                            /* -fdec */
  OPT_fdec_blank_format_item = 978,          /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 979,           /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 980,            /* -fdec-format-defaults */
  OPT_fdec_include = 981,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 982,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 983,                       /* -fdec-math */
  OPT_fdec_static = 984,                     /* -fdec-static */
  OPT_fdec_structure = 985,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 986,              /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 987, */         /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 988,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 989, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 990,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 991,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 992,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 993,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 994,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 995,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 996,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 997,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 998,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 999,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1000,    /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 1001, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1002,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1003,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1004,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_format_ = 1005,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1006,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 1007,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1008,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1009,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1010,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_show_caret = 1011,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1012,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 1013,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1014, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1015,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1016,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1017,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_template_tree = 1018,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 1019,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1020,               /* -fdirectives-only */
  OPT_fdisable_ = 1021,                      /* -fdisable- */
  OPT_fdoc = 1022,                           /* -fdoc */
  OPT_fdoc_dir_ = 1023,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1024,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1025,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1026,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1027,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1028,                      /* -fdruntime */
  OPT_fdse = 1029,                           /* -fdse */
  OPT_fdump_ = 1030,                         /* -fdump- */
  OPT_fdump_ada_spec = 1031,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1032,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1033,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1034,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1035,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1036,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1037,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1038,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_feasibility = 1039,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_json = 1040,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1041,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1042,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1043,      /* -fdump-analyzer-supergraph */
  /* OPT_fdump_core = 1044, */               /* -fdump-core */
  OPT_fdump_d_original = 1045,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1046,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1047,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1048,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1049,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1050,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1051,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1052,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1053,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1054, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1055,                   /* -fdump-passes */
  OPT_fdump_scos = 1056,                     /* -fdump-scos */
  OPT_fdump_unnumbered = 1057,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1058,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1059,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1060,                /* -fearly-inlining */
  OPT_felide_constructors = 1061,            /* -felide-constructors */
  OPT_felide_type = 1062,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1063, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1064,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1065,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1066,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1067,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1068,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1069,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1070,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1071,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1072,                /* -fenum-int-equiv */
  OPT_fexceptions = 1073,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1074,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1075,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1076,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1077,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1078,          /* -fextended-identifiers */
  OPT_fextern_tls_init = 1079,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1080,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1081,            /* -fexternal-templates */
  OPT_ff2c = 1082,                           /* -ff2c */
  OPT_ffast_math = 1083,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1084,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1085,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1086,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1087,              /* -ffinite-math-only */
  OPT_ffixed_ = 1088,                        /* -ffixed- */
  OPT_ffixed_form = 1089,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1090,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1091,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1092,                   /* -ffloat-store */
  OPT_ffor_scope = 1093,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1094, */              /* -fforce-addr */
  OPT_fforward_propagate = 1095,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1096,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1097,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1098,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1099,                     /* -ffpe-trap= */
  OPT_ffree_form = 1100,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1101,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1102,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1103,                  /* -ffreestanding */
  OPT_ffriend_injection = 1104,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1105,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1106,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1107,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1108,             /* -ffunction-sections */
  OPT_fgcse = 1109,                          /* -fgcse */
  OPT_fgcse_after_reload = 1110,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1111,                      /* -fgcse-las */
  OPT_fgcse_lm = 1112,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1113,                       /* -fgcse-sm */
  OPT_fgimple = 1114,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1115,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1116,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1117,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1118,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1119,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1120,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1121,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1122,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1123,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1124,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1125,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1126,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1127,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1128,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1129,                  /* -fgo-embedcfg= */
  OPT_fgo_optimize_ = 1130,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1131,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1132,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1133,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1134,                      /* -fgraphite */
  OPT_fgraphite_identity = 1135,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1136,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1137,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1138, */       /* -fhandle-exceptions */
  /* OPT_fhelp = 1139, */                    /* -fhelp */
  /* OPT_fhelp_ = 1140, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1141,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1142,                     /* -fhonor-std */
  OPT_fhosted = 1143,                        /* -fhosted */
  OPT_fhuge_objects = 1144,                  /* -fhuge-objects */
  OPT_fident = 1145,                         /* -fident */
  OPT_fif_conversion = 1146,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1147,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1148,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1149,             /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 1150,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1151,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1152,            /* -fimplicit-templates */
  OPT_findirect_inlining = 1153,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1154,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1155,               /* -finit-character= */
  OPT_finit_derived = 1156,                  /* -finit-derived */
  OPT_finit_integer_ = 1157,                 /* -finit-integer= */
  OPT_finit_local_zero = 1158,               /* -finit-local-zero */
  OPT_finit_logical_ = 1159,                 /* -finit-logical= */
  OPT_finit_real_ = 1160,                    /* -finit-real= */
  OPT_finline = 1161,                        /* -finline */
  OPT_finline_arg_packing = 1162,            /* -finline-arg-packing */
  OPT_finline_atomics = 1163,                /* -finline-atomics */
  OPT_finline_functions = 1164,              /* -finline-functions */
  OPT_finline_functions_called_once = 1165,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1166, */           /* -finline-limit- */
  OPT_finline_limit_ = 1167,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1168,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1169,        /* -finline-small-functions */
  OPT_finput_charset_ = 1170,                /* -finput-charset= */
  OPT_finstrument_functions = 1171,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1172,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1173,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 1174,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1175,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1176,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1177,                    /* -finvariants */
  OPT_fipa_bit_cp = 1178,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1179,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1180, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1181,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1182,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1183,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1184,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1185, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1186,                    /* -fipa-modref */
  OPT_fipa_profile = 1187,                   /* -fipa-profile */
  OPT_fipa_pta = 1188,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1189,                /* -fipa-pure-const */
  OPT_fipa_ra = 1190,                        /* -fipa-ra */
  OPT_fipa_reference = 1191,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1192,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1193,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1194,           /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 1195, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1196,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1197,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1198,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1199,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1200,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1201,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1202,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1203,                  /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 1204,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1205,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1206,              /* -fivar-visibility= */
  OPT_fivopts = 1207,                        /* -fivopts */
  OPT_fjump_tables = 1208,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1209,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1210,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1211,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1212,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1213,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1214,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1215,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1216,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1217,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1218,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1219,         /* -flang-info-module-cmi= */
  OPT_flarge_source_files = 1220,            /* -flarge-source-files */
  OPT_flax_vector_conversions = 1221,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1222,            /* -fleading-underscore */
  OPT_flifetime_dse = 1223,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1224,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1225,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1226,                /* -flinker-output= */
  /* OPT_flive_patching = 1227, */           /* -flive-patching */
  OPT_flive_patching_ = 1228,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1229,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1230,                   /* -flocal-ivars */
  /* OPT_floop_block = 1231, */              /* -floop-block */
  /* OPT_floop_flatten = 1232, */            /* -floop-flatten */
  OPT_floop_interchange = 1233,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1234,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1235, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1236,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1237, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1238,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1239,                     /* -flra-remat */
  OPT_flto = 1240,                           /* -flto */
  OPT_flto_compression_level_ = 1241,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1242, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1243,                /* -flto-partition= */
  OPT_flto_report = 1244,                    /* -flto-report */
  OPT_flto_report_wpa = 1245,                /* -flto-report-wpa */
  OPT_flto_ = 1246,                          /* -flto= */
  OPT_fltrans = 1247,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1248,           /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 1249,             /* -fmacro-prefix-map= */
  OPT_fmain = 1250,                          /* -fmain */
  OPT_fmath_errno = 1251,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1252,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1253,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1254,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1255,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1256,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1257,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1258,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1259,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1260,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1261,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1262,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1263,               /* -fmessage-length= */
  OPT_fmodule_file_ = 1264,                  /* -fmodule-file= */
  OPT_fmodule_header = 1265,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1266,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1267,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1268,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1269,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1270,                   /* -fmodule-only */
  OPT_fmodule_private = 1271,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1272,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1273,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1274,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1275,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1276,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1277,          /* -fmove-loop-invariants */
  OPT_fms_extensions = 1278,                 /* -fms-extensions */
  OPT_fmudflap = 1279,                       /* -fmudflap */
  OPT_fmudflapir = 1280,                     /* -fmudflapir */
  OPT_fmudflapth = 1281,                     /* -fmudflapth */
  OPT_fname_mangling_version_ = 1282,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1283,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1284,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1285,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1286,                  /* -fnext-runtime */
  OPT_fnil_receivers = 1287,                 /* -fnil-receivers */
  OPT_fno_modules = 1288,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1289,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1290,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1291,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1292,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1293,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1294,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1295,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1296,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1297,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1298,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1299,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1300,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1301,                  /* -foffload-abi= */
  OPT_foffload_ = 1302,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1303,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1304,                         /* -fonly= */
  OPT_fopenacc = 1305,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1306,                  /* -fopenacc-dim= */
  OPT_fopenacc_kernels_ = 1307,              /* -fopenacc-kernels= */
  OPT_fopenmp = 1308,                        /* -fopenmp */
  OPT_fopenmp_simd = 1309,                   /* -fopenmp-simd */
  OPT_foperator_names = 1310,                /* -foperator-names */
  OPT_fopt_info = 1311,                      /* -fopt-info */
  OPT_fopt_info_ = 1312,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1313, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1314,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1315,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1316, */          /* -foptional-diags */
  OPT_fpack_derived = 1317,                  /* -fpack-derived */
  OPT_fpack_struct = 1318,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1319,                  /* -fpack-struct= */
  OPT_fpad_source = 1320,                    /* -fpad-source */
  OPT_fpartial_inlining = 1321,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1322,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1323,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1324,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1325,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1326,                    /* -fpeel-loops */
  OPT_fpeephole = 1327,                      /* -fpeephole */
  OPT_fpeephole2 = 1328,                     /* -fpeephole2 */
  OPT_fpermissive = 1329,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1330,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1331,                           /* -fpic */
  OPT_fpie = 1332,                           /* -fpie */
  OPT_fplan9_extensions = 1333,              /* -fplan9-extensions */
  OPT_fplt = 1334,                           /* -fplt */
  OPT_fplugin_arg_ = 1335,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1336,                       /* -fplugin= */
  OPT_fpost_ipa_mem_report = 1337,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1338,                /* -fpostconditions */
  OPT_fpre_include_ = 1339,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1340,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1341,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1342,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1343,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1344,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1345,              /* -fpretty-templates */
  OPT_fprintf_return_value = 1346,           /* -fprintf-return-value */
  OPT_fprofile = 1347,                       /* -fprofile */
  OPT_fprofile_abs_path = 1348,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1349,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1350,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1351,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1352,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1353,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1354,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1355,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1356,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1357,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1358,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1359,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_path_ = 1360,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1361,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1362,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1363,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1364,               /* -fprofile-update= */
  OPT_fprofile_use = 1365,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1366,                  /* -fprofile-use= */
  OPT_fprofile_values = 1367,                /* -fprofile-values */
  OPT_fprotect_parens = 1368,                /* -fprotect-parens */
  OPT_frandom_seed = 1369,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1370,                  /* -frandom-seed= */
  OPT_frange_check = 1371,                   /* -frange-check */
  OPT_freal_4_real_10 = 1372,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1373,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1374,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1375,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1376,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1377,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1378,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1379,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1380,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1381,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1382,               /* -frecord-marker=8 */
  OPT_frecursive = 1383,                     /* -frecursive */
  OPT_free = 1384,                           /* -free */
  OPT_freg_struct_return = 1385,             /* -freg-struct-return */
  /* OPT_fregmove = 1386, */                 /* -fregmove */
  OPT_frelease = 1387,                       /* -frelease */
  OPT_frename_registers = 1388,              /* -frename-registers */
  OPT_freorder_blocks = 1389,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1390,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1391,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1392,             /* -freorder-functions */
  OPT_frepack_arrays = 1393,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1394,          /* -freplace-objc-classes */
  OPT_frepo = 1395,                          /* -frepo */
  OPT_freport_bug = 1396,                    /* -freport-bug */
  OPT_frequire_return_statement = 1397,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1398,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1399, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1400,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1401,                   /* -fresolution= */
  OPT_frounding_math = 1402,                 /* -frounding-math */
  OPT_frtti = 1403,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1404,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1405,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1406,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1407,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1408,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1409,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1410,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1411,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1412, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1413,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1414,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1415,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1416,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1417,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1418,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1419,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1420,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1421,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1422,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1423,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1424,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1425,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1426,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1427,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1428,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1429, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1430,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1431,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1432,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1433,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1434,               /* -fsection-anchors */
  /* OPT_fsee = 1435, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1436,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1437,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1438,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1439,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1440,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1441,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1442,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1443,                   /* -fshort-enums */
  OPT_fshort_wchar = 1444,                   /* -fshort-wchar */
  OPT_fshow_column = 1445,                   /* -fshow-column */
  OPT_fshrink_wrap = 1446,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1447,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1448,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1449,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1450,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1451,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1452,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1453,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1454,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1455,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1456,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1457,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1458,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1459,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1460,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1461,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1462,                      /* -fsquangle */
  OPT_fssa_backprop = 1463,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1464,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1465,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1466,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1467, */             /* -fstack-check */
  OPT_fstack_check_ = 1468,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1469,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1470,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1471,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1472,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1473,               /* -fstack-protector */
  OPT_fstack_protector_all = 1474,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1475,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1476,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1477,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1478,                   /* -fstack-usage */
  OPT_fstats = 1479,                         /* -fstats */
  OPT_fstdarg_opt = 1480,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1481,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1482, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1483,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1484,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1485,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1486,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1487,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1488, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1489,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1490,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1491,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1492,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1493,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1494, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1495,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1496, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1497,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1498, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1499,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1500,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1501,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1502,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1503,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1504,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1505,                   /* -ftime-report */
  OPT_ftime_report_details = 1506,           /* -ftime-report-details */
  OPT_ftls_model_ = 1507,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1508,              /* -ftoplevel-reorder */
  OPT_ftracer = 1509,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1510,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1511,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1512,                   /* -ftrampolines */
  OPT_ftransition_all = 1513,                /* -ftransition=all */
  OPT_ftransition_complex = 1514,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1515,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1516,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1517,              /* -ftransition=field */
  OPT_ftransition_nogc = 1518,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1519,                /* -ftransition=tls */
  OPT_ftrapping_math = 1520,                 /* -ftrapping-math */
  OPT_ftrapv = 1521,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1522,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1523,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1524,                      /* -ftree-ccp */
  OPT_ftree_ch = 1525,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1526, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1527,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1528,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1529, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1530,                   /* -ftree-cselim */
  OPT_ftree_dce = 1531,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1532,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1533,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1534,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1535,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1536, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1537,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1538,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1539, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1540,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1541,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1542, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1543,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1544,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1545,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1546,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1547,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1548,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1549,                      /* -ftree-pre */
  OPT_ftree_pta = 1550,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1551,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1552, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1553,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1554,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1555,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1556,                     /* -ftree-slsr */
  OPT_ftree_sra = 1557,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1558, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1559, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1560,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1561,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1562,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1563, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1564,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1565, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1566,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1567,         /* -funconstrained-commons */
  OPT_funderscoring = 1568,                  /* -funderscoring */
  OPT_funit_at_a_time = 1569,                /* -funit-at-a-time */
  OPT_funittest = 1570,                      /* -funittest */
  OPT_funroll_all_loops = 1571,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1572,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1573,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1574, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1575,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1576,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1577,                 /* -funsigned-char */
  OPT_funswitch_loops = 1578,                /* -funswitch-loops */
  OPT_funwind_tables = 1579,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1580,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1581,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1582,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1583,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1584,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1585,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1586,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1587,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1588,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1589,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1590,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1591, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1592,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1593,                   /* -fverbose-asm */
  /* OPT_fversion = 1594, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1595,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1596,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1597,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1598,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1599,                   /* -fvisibility= */
  OPT_fvpt = 1600,                           /* -fvpt */
  OPT_fvtable_gc = 1601,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1602,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1603,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1604,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1605,                     /* -fvtv-debug */
  OPT_fweak = 1606,                          /* -fweak */
  OPT_fweak_templates = 1607,                /* -fweak-templates */
  OPT_fweb = 1608,                           /* -fweb */
  /* OPT_fwhole_file = 1609, */              /* -fwhole-file */
  OPT_fwhole_program = 1610,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1611,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1612,             /* -fworking-directory */
  OPT_fwpa = 1613,                           /* -fwpa */
  OPT_fwpa_ = 1614,                          /* -fwpa= */
  OPT_fwrapv = 1615,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1616,                 /* -fwrapv-pointer */
  OPT_fxref = 1617,                          /* -fxref */
  /* OPT_fzee = 1618, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1619,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1620,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1621,                     /* -fzero-link */
  OPT_g = 1622,                              /* -g */
  OPT_gant = 1623,                           /* -gant */
  OPT_gas_loc_support = 1624,                /* -gas-loc-support */
  OPT_gas_locview_support = 1625,            /* -gas-locview-support */
  OPT_gcoff = 1626,                          /* -gcoff */
  OPT_gcoff1 = 1627,                         /* -gcoff1 */
  OPT_gcoff2 = 1628,                         /* -gcoff2 */
  OPT_gcoff3 = 1629,                         /* -gcoff3 */
  OPT_gcolumn_info = 1630,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1631,                 /* -gdescribe-dies */
  OPT_gdwarf = 1632,                         /* -gdwarf */
  OPT_gdwarf_ = 1633,                        /* -gdwarf- */
  OPT_gdwarf32 = 1634,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1635,                       /* -gdwarf64 */
  OPT_gen_decls = 1636,                      /* -gen-decls */
  OPT_ggdb = 1637,                           /* -ggdb */
  OPT_ggnu_pubnames = 1638,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1639,                   /* -gimple-stats */
  OPT_ginline_points = 1640,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1641, /* -ginternal-reset-location-views */
  OPT_gnat = 1642,                           /* -gnat */
  OPT_gnatO = 1643,                          /* -gnatO */
  OPT_gno_ = 1644,                           /* -gno- */
  OPT_gno_pubnames = 1645,                   /* -gno-pubnames */
  OPT_gpubnames = 1646,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1647,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1648,                   /* -gsplit-dwarf */
  OPT_gstabs = 1649,                         /* -gstabs */
  OPT_gstabs_ = 1650,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1651,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1652,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1653,                        /* -gtoggle */
  OPT_gvariable_location_views = 1654,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1655,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1656,                           /* -gvms */
  OPT_gxcoff = 1657,                         /* -gxcoff */
  OPT_gxcoff_ = 1658,                        /* -gxcoff+ */
  OPT_gz = 1659,                             /* -gz */
  OPT_gz_ = 1660,                            /* -gz= */
  OPT_h = 1661,                              /* -h */
  OPT_help = 1662,                           /* -help */
  OPT_idirafter = 1663,                      /* -idirafter */
  OPT_imacros = 1664,                        /* -imacros */
  OPT_imultiarch = 1665,                     /* -imultiarch */
  OPT_imultilib = 1666,                      /* -imultilib */
  OPT_include = 1667,                        /* -include */
  OPT_iplugindir_ = 1668,                    /* -iplugindir= */
  OPT_iprefix = 1669,                        /* -iprefix */
  OPT_iquote = 1670,                         /* -iquote */
  OPT_isysroot = 1671,                       /* -isysroot */
  OPT_isystem = 1672,                        /* -isystem */
  OPT_iwithprefix = 1673,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1674,              /* -iwithprefixbefore */
  OPT_k8 = 1675,                             /* -k8 */
  OPT_l = 1676,                              /* -l */
  OPT_lang_asm = 1677,                       /* -lang-asm */
  OPT_list = 1678,                           /* -list */
  OPT_mabi_ = 1679,                          /* -mabi= */
  OPT_march_ = 1680,                         /* -march= */
  OPT_mbig_endian = 1681,                    /* -mbig-endian */
  OPT_mbionic = 1682,                        /* -mbionic */
  ...
  OPT_mglibc = 1689,                         /* -mglibc */
  OPT_mharden_sls_ = 1690,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1691,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1692,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1693,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1694,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1695,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1696,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1697,               /* -moutline-atomics */
  OPT_moverride_ = 1698,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1699,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1700,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1701, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1702,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1703,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1704,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1705,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1706,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1707,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1708,             /* -mtrack-speculation */
  OPT_mtune_ = 1709,                         /* -mtune= */
  OPT_muclibc = 1710,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1711,             /* -mverbose-cost-dump */
  OPT_n = 1712,                              /* -n */
  OPT_name_sort = 1713,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1714,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1715,              /* -no-integrated-cpp */
  OPT_no_pie = 1716,                         /* -no-pie */
  OPT_nocpp = 1717,                          /* -nocpp */
  OPT_nodefaultlibs = 1718,                  /* -nodefaultlibs */
  OPT_nolibc = 1719,                         /* -nolibc */
  OPT_nophoboslib = 1720,                    /* -nophoboslib */
  OPT_nostartfiles = 1721,                   /* -nostartfiles */
  OPT_nostdinc = 1722,                       /* -nostdinc */
  OPT_nostdinc__ = 1723,                     /* -nostdinc++ */
  OPT_nostdlib = 1724,                       /* -nostdlib */
  OPT_o = 1725,                              /* -o */
  OPT_objects = 1726,                        /* -objects */
  OPT_p = 1727,                              /* -p */
  OPT_pass_exit_codes = 1728,                /* -pass-exit-codes */
  /* OPT_pedantic = 1729, */                 /* -pedantic */
  OPT_pedantic_errors = 1730,                /* -pedantic-errors */
  OPT_pg = 1731,                             /* -pg */
  OPT_pie = 1732,                            /* -pie */
  OPT_pipe = 1733,                           /* -pipe */
  OPT_posix = 1734,                          /* -posix */
  OPT_print_file_name_ = 1735,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1736,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1737,          /* -print-multi-directory */
  OPT_print_multi_lib = 1738,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1739,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1740,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1741,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1742,               /* -print-prog-name= */
  OPT_print_search_dirs = 1743,              /* -print-search-dirs */
  OPT_print_sysroot = 1744,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1745,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1746,                    /* -print-value */
  OPT_profile = 1747,                        /* -profile */
  OPT_pthread = 1748,                        /* -pthread */
  OPT_quiet = 1749,                          /* -quiet */
  OPT_r = 1750,                              /* -r */
  OPT_rdynamic = 1751,                       /* -rdynamic */
  OPT_remap = 1752,                          /* -remap */
  OPT_reverse_sort = 1753,                   /* -reverse-sort */
  OPT_s = 1754,                              /* -s */
  OPT_save_temps = 1755,                     /* -save-temps */
  OPT_save_temps_ = 1756,                    /* -save-temps= */
  OPT_shared = 1757,                         /* -shared */
  OPT_shared_libgcc = 1758,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1759,               /* -shared-libphobos */
  OPT_size_sort = 1760,                      /* -size-sort */
  /* OPT_specs = 1761, */                    /* -specs */
  OPT_specs_ = 1762,                         /* -specs= */
  OPT_static = 1763,                         /* -static */
  OPT_static_libasan = 1764,                 /* -static-libasan */
  OPT_static_libgcc = 1765,                  /* -static-libgcc */
  OPT_static_libgfortran = 1766,             /* -static-libgfortran */
  OPT_static_libgo = 1767,                   /* -static-libgo */
  OPT_static_libhwasan = 1768,               /* -static-libhwasan */
  OPT_static_liblsan = 1769,                 /* -static-liblsan */
  OPT_static_libmpx = 1770,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1771,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1772,               /* -static-libphobos */
  OPT_static_libstdc__ = 1773,               /* -static-libstdc++ */
  OPT_static_libtsan = 1774,                 /* -static-libtsan */
  OPT_static_libubsan = 1775,                /* -static-libubsan */
  OPT_static_pie = 1776,                     /* -static-pie */
  /* OPT_std_c__03 = 1777, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1778, */                /* -std=c++0x */
  OPT_std_c__11 = 1779,                      /* -std=c++11 */
  OPT_std_c__14 = 1780,                      /* -std=c++14 */
  OPT_std_c__17 = 1781,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1782, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1783, */                /* -std=c++1z */
  OPT_std_c__20 = 1784,                      /* -std=c++20 */
  OPT_std_c__23 = 1785,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1786, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1787, */                /* -std=c++2b */
  OPT_std_c__98 = 1788,                      /* -std=c++98 */
  OPT_std_c11 = 1789,                        /* -std=c11 */
  OPT_std_c17 = 1790,                        /* -std=c17 */
  /* OPT_std_c18 = 1791, */                  /* -std=c18 */
  /* OPT_std_c1x = 1792, */                  /* -std=c1x */
  OPT_std_c2x = 1793,                        /* -std=c2x */
  /* OPT_std_c89 = 1794, */                  /* -std=c89 */
  OPT_std_c90 = 1795,                        /* -std=c90 */
  OPT_std_c99 = 1796,                        /* -std=c99 */
  /* OPT_std_c9x = 1797, */                  /* -std=c9x */
  OPT_std_f2003 = 1798,                      /* -std=f2003 */
  OPT_std_f2008 = 1799,                      /* -std=f2008 */
  OPT_std_f2008ts = 1800,                    /* -std=f2008ts */
  OPT_std_f2018 = 1801,                      /* -std=f2018 */
  OPT_std_f95 = 1802,                        /* -std=f95 */
  OPT_std_gnu = 1803,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1804, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1805, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1806,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1807,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1808,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1809, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1810, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1811,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1812,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1813, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1814, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1815,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1816,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1817,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1818, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1819, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1820,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1821, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1822,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1823,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1824, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1825, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1826,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1827, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1828, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1829, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1830, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1831, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1832,                     /* -std=legacy */
  OPT_stdlib_ = 1833,                        /* -stdlib= */
  OPT_symbol_ = 1834,                        /* -symbol= */
  OPT_symbolic = 1835,                       /* -symbolic */
  OPT_t = 1836,                              /* -t */
  OPT_time = 1837,                           /* -time */
  OPT_time_ = 1838,                          /* -time= */
  OPT_traditional = 1839,                    /* -traditional */
  OPT_traditional_cpp = 1840,                /* -traditional-cpp */
  OPT_tree_stats = 1841,                     /* -tree-stats */
  OPT_trigraphs = 1842,                      /* -trigraphs */
  OPT_type_stats = 1843,                     /* -type-stats */
  OPT_u = 1844,                              /* -u */
  OPT_undef = 1845,                          /* -undef */
  OPT_v = 1846,                              /* -v */
  OPT_version = 1847,                        /* -version */
  OPT_w = 1848,                              /* -w */
  OPT_wrapper = 1849,                        /* -wrapper */
  OPT_x = 1850,                              /* -x */
  OPT_z = 1851,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
