...
enum opt_code
{
  ...
  OPT__param_ipa_cp_loop_hint_bonus_ = 115,  /* --param=ipa-cp-loop-hint-bonus= */
  OPT__param_ipa_cp_max_recursive_depth_ = 116,/* --param=ipa-cp-max-recursive-depth= */
  OPT__param_ipa_cp_min_recursive_probability_ = 117,/* --param=ipa-cp-min-recursive-probability= */
  OPT__param_ipa_cp_recursion_penalty_ = 118,/* --param=ipa-cp-recursion-penalty= */
  OPT__param_ipa_cp_single_call_penalty_ = 119,/* --param=ipa-cp-single-call-penalty= */
  OPT__param_ipa_cp_unit_growth_ = 120,      /* --param=ipa-cp-unit-growth= */
  OPT__param_ipa_cp_value_list_size_ = 121,  /* --param=ipa-cp-value-list-size= */
  OPT__param_ipa_max_aa_steps_ = 122,        /* --param=ipa-max-aa-steps= */
  OPT__param_ipa_max_agg_items_ = 123,       /* --param=ipa-max-agg-items= */
  OPT__param_ipa_max_param_expr_ops_ = 124,  /* --param=ipa-max-param-expr-ops= */
  OPT__param_ipa_max_switch_predicate_bounds_ = 125,/* --param=ipa-max-switch-predicate-bounds= */
  OPT__param_ipa_sra_max_replacements_ = 126,/* --param=ipa-sra-max-replacements= */
  OPT__param_ipa_sra_ptr_growth_factor_ = 127,/* --param=ipa-sra-ptr-growth-factor= */
  OPT__param_ira_loop_reserved_regs_ = 128,  /* --param=ira-loop-reserved-regs= */
  OPT__param_ira_max_conflict_table_size_ = 129,/* --param=ira-max-conflict-table-size= */
  OPT__param_ira_max_loops_num_ = 130,       /* --param=ira-max-loops-num= */
  OPT__param_iv_always_prune_cand_set_bound_ = 131,/* --param=iv-always-prune-cand-set-bound= */
  OPT__param_iv_consider_all_candidates_bound_ = 132,/* --param=iv-consider-all-candidates-bound= */
  OPT__param_iv_max_considered_uses_ = 133,  /* --param=iv-max-considered-uses= */
  OPT__param_jump_table_max_growth_ratio_for_size_ = 134,/* --param=jump-table-max-growth-ratio-for-size= */
  OPT__param_jump_table_max_growth_ratio_for_speed_ = 135,/* --param=jump-table-max-growth-ratio-for-speed= */
  OPT__param_l1_cache_line_size_ = 136,      /* --param=l1-cache-line-size= */
  OPT__param_l1_cache_size_ = 137,           /* --param=l1-cache-size= */
  OPT__param_l2_cache_size_ = 138,           /* --param=l2-cache-size= */
  OPT__param_large_function_growth_ = 139,   /* --param=large-function-growth= */
  OPT__param_large_function_insns_ = 140,    /* --param=large-function-insns= */
  OPT__param_large_stack_frame_growth_ = 141,/* --param=large-stack-frame-growth= */
  OPT__param_large_stack_frame_ = 142,       /* --param=large-stack-frame= */
  OPT__param_large_unit_insns_ = 143,        /* --param=large-unit-insns= */
  OPT__param_lim_expensive_ = 144,           /* --param=lim-expensive= */
  OPT__param_logical_op_non_short_circuit_ = 145,/* --param=logical-op-non-short-circuit= */
  OPT__param_loop_block_tile_size_ = 146,    /* --param=loop-block-tile-size= */
  OPT__param_loop_interchange_max_num_stmts_ = 147,/* --param=loop-interchange-max-num-stmts= */
  OPT__param_loop_interchange_stride_ratio_ = 148,/* --param=loop-interchange-stride-ratio= */
  OPT__param_loop_invariant_max_bbs_in_loop_ = 149,/* --param=loop-invariant-max-bbs-in-loop= */
  OPT__param_loop_max_datarefs_for_datadeps_ = 150,/* --param=loop-max-datarefs-for-datadeps= */
  OPT__param_loop_versioning_max_inner_insns_ = 151,/* --param=loop-versioning-max-inner-insns= */
  OPT__param_loop_versioning_max_outer_insns_ = 152,/* --param=loop-versioning-max-outer-insns= */
  OPT__param_lra_inheritance_ebb_probability_cutoff_ = 153,/* --param=lra-inheritance-ebb-probability-cutoff= */
  OPT__param_lra_max_considered_reload_pseudos_ = 154,/* --param=lra-max-considered-reload-pseudos= */
  OPT__param_lto_max_partition_ = 155,       /* --param=lto-max-partition= */
  OPT__param_lto_max_streaming_parallelism_ = 156,/* --param=lto-max-streaming-parallelism= */
  OPT__param_lto_min_partition_ = 157,       /* --param=lto-min-partition= */
  OPT__param_lto_partitions_ = 158,          /* --param=lto-partitions= */
  OPT__param_max_average_unrolled_insns_ = 159,/* --param=max-average-unrolled-insns= */
  OPT__param_max_combine_insns_ = 160,       /* --param=max-combine-insns= */
  OPT__param_max_completely_peel_loop_nest_depth_ = 161,/* --param=max-completely-peel-loop-nest-depth= */
  OPT__param_max_completely_peel_times_ = 162,/* --param=max-completely-peel-times= */
  OPT__param_max_completely_peeled_insns_ = 163,/* --param=max-completely-peeled-insns= */
  OPT__param_max_crossjump_edges_ = 164,     /* --param=max-crossjump-edges= */
  OPT__param_max_cse_insns_ = 165,           /* --param=max-cse-insns= */
  OPT__param_max_cse_path_length_ = 166,     /* --param=max-cse-path-length= */
  OPT__param_max_cselib_memory_locations_ = 167,/* --param=max-cselib-memory-locations= */
  OPT__param_max_debug_marker_count_ = 168,  /* --param=max-debug-marker-count= */
  OPT__param_max_delay_slot_insn_search_ = 169,/* --param=max-delay-slot-insn-search= */
  OPT__param_max_delay_slot_live_search_ = 170,/* --param=max-delay-slot-live-search= */
  OPT__param_max_dse_active_local_stores_ = 171,/* --param=max-dse-active-local-stores= */
  OPT__param_max_early_inliner_iterations_ = 172,/* --param=max-early-inliner-iterations= */
  OPT__param_max_fields_for_field_sensitive_ = 173,/* --param=max-fields-for-field-sensitive= */
  OPT__param_max_find_base_term_values_ = 174,/* --param=max-find-base-term-values= */
  OPT__param_max_fsm_thread_length_ = 175,   /* --param=max-fsm-thread-length= */
  OPT__param_max_fsm_thread_path_insns_ = 176,/* --param=max-fsm-thread-path-insns= */
  OPT__param_max_fsm_thread_paths_ = 177,    /* --param=max-fsm-thread-paths= */
  OPT__param_max_gcse_insertion_ratio_ = 178,/* --param=max-gcse-insertion-ratio= */
  OPT__param_max_gcse_memory_ = 179,         /* --param=max-gcse-memory= */
  OPT__param_max_goto_duplication_insns_ = 180,/* --param=max-goto-duplication-insns= */
  OPT__param_max_grow_copy_bb_insns_ = 181,  /* --param=max-grow-copy-bb-insns= */
  OPT__param_max_hoist_depth_ = 182,         /* --param=max-hoist-depth= */
  OPT__param_max_inline_insns_auto_ = 183,   /* --param=max-inline-insns-auto= */
  OPT__param_max_inline_insns_recursive_auto_ = 184,/* --param=max-inline-insns-recursive-auto= */
  OPT__param_max_inline_insns_recursive_ = 185,/* --param=max-inline-insns-recursive= */
  OPT__param_max_inline_insns_single_ = 186, /* --param=max-inline-insns-single= */
  OPT__param_max_inline_insns_size_ = 187,   /* --param=max-inline-insns-size= */
  OPT__param_max_inline_insns_small_ = 188,  /* --param=max-inline-insns-small= */
  OPT__param_max_inline_recursive_depth_auto_ = 189,/* --param=max-inline-recursive-depth-auto= */
  OPT__param_max_inline_recursive_depth_ = 190,/* --param=max-inline-recursive-depth= */
  OPT__param_max_isl_operations_ = 191,      /* --param=max-isl-operations= */
  OPT__param_max_iterations_computation_cost_ = 192,/* --param=max-iterations-computation-cost= */
  OPT__param_max_iterations_to_track_ = 193, /* --param=max-iterations-to-track= */
  OPT__param_max_jump_thread_duplication_stmts_ = 194,/* --param=max-jump-thread-duplication-stmts= */
  OPT__param_max_last_value_rtl_ = 195,      /* --param=max-last-value-rtl= */
  OPT__param_max_loop_header_insns_ = 196,   /* --param=max-loop-header-insns= */
  OPT__param_max_modulo_backtrack_attempts_ = 197,/* --param=max-modulo-backtrack-attempts= */
  OPT__param_max_partial_antic_length_ = 198,/* --param=max-partial-antic-length= */
  OPT__param_max_peel_branches_ = 199,       /* --param=max-peel-branches= */
  OPT__param_max_peel_times_ = 200,          /* --param=max-peel-times= */
  OPT__param_max_peeled_insns_ = 201,        /* --param=max-peeled-insns= */
  OPT__param_max_pending_list_length_ = 202, /* --param=max-pending-list-length= */
  OPT__param_max_pipeline_region_blocks_ = 203,/* --param=max-pipeline-region-blocks= */
  OPT__param_max_pipeline_region_insns_ = 204,/* --param=max-pipeline-region-insns= */
  OPT__param_max_pow_sqrt_depth_ = 205,      /* --param=max-pow-sqrt-depth= */
  OPT__param_max_predicted_iterations_ = 206,/* --param=max-predicted-iterations= */
  OPT__param_max_reload_search_insns_ = 207, /* --param=max-reload-search-insns= */
  OPT__param_max_rtl_if_conversion_insns_ = 208,/* --param=max-rtl-if-conversion-insns= */
  OPT__param_max_rtl_if_conversion_predictable_cost_ = 209,/* --param=max-rtl-if-conversion-predictable-cost= */
  OPT__param_max_rtl_if_conversion_unpredictable_cost_ = 210,/* --param=max-rtl-if-conversion-unpredictable-cost= */
  OPT__param_max_sched_extend_regions_iters_ = 211,/* --param=max-sched-extend-regions-iters= */
  OPT__param_max_sched_insn_conflict_delay_ = 212,/* --param=max-sched-insn-conflict-delay= */
  OPT__param_max_sched_ready_insns_ = 213,   /* --param=max-sched-ready-insns= */
  OPT__param_max_sched_region_blocks_ = 214, /* --param=max-sched-region-blocks= */
  OPT__param_max_sched_region_insns_ = 215,  /* --param=max-sched-region-insns= */
  OPT__param_max_slsr_cand_scan_ = 216,      /* --param=max-slsr-cand-scan= */
  OPT__param_max_speculative_devirt_maydefs_ = 217,/* --param=max-speculative-devirt-maydefs= */
  OPT__param_max_ssa_name_query_depth_ = 218,/* --param=max-ssa-name-query-depth= */
  OPT__param_max_stores_to_merge_ = 219,     /* --param=max-stores-to-merge= */
  OPT__param_max_stores_to_sink_ = 220,      /* --param=max-stores-to-sink= */
  OPT__param_max_tail_merge_comparisons_ = 221,/* --param=max-tail-merge-comparisons= */
  OPT__param_max_tail_merge_iterations_ = 222,/* --param=max-tail-merge-iterations= */
  OPT__param_max_tracked_strlens_ = 223,     /* --param=max-tracked-strlens= */
  OPT__param_max_tree_if_conversion_phi_args_ = 224,/* --param=max-tree-if-conversion-phi-args= */
  OPT__param_max_unroll_times_ = 225,        /* --param=max-unroll-times= */
  OPT__param_max_unrolled_insns_ = 226,      /* --param=max-unrolled-insns= */
  OPT__param_max_unswitch_insns_ = 227,      /* --param=max-unswitch-insns= */
  OPT__param_max_unswitch_level_ = 228,      /* --param=max-unswitch-level= */
  OPT__param_max_variable_expansions_in_unroller_ = 229,/* --param=max-variable-expansions-in-unroller= */
  OPT__param_max_vartrack_expr_depth_ = 230, /* --param=max-vartrack-expr-depth= */
  OPT__param_max_vartrack_reverse_op_size_ = 231,/* --param=max-vartrack-reverse-op-size= */
  OPT__param_max_vartrack_size_ = 232,       /* --param=max-vartrack-size= */
  OPT__param_max_vrp_switch_assertions_ = 233,/* --param=max-vrp-switch-assertions= */
  OPT__param_min_crossjump_insns_ = 234,     /* --param=min-crossjump-insns= */
  OPT__param_min_inline_recursive_probability_ = 235,/* --param=min-inline-recursive-probability= */
  OPT__param_min_insn_to_prefetch_ratio_ = 236,/* --param=min-insn-to-prefetch-ratio= */
  OPT__param_min_loop_cond_split_prob_ = 237,/* --param=min-loop-cond-split-prob= */
  OPT__param_min_nondebug_insn_uid_ = 238,   /* --param=min-nondebug-insn-uid= */
  OPT__param_min_size_for_stack_sharing_ = 239,/* --param=min-size-for-stack-sharing= */
  OPT__param_min_spec_prob_ = 240,           /* --param=min-spec-prob= */
  OPT__param_min_vect_loop_bound_ = 241,     /* --param=min-vect-loop-bound= */
  OPT__param_modref_max_accesses_ = 242,     /* --param=modref-max-accesses= */
  OPT__param_modref_max_bases_ = 243,        /* --param=modref-max-bases= */
  OPT__param_modref_max_refs_ = 244,         /* --param=modref-max-refs= */
  OPT__param_modref_max_tests_ = 245,        /* --param=modref-max-tests= */
  OPT__param_parloops_chunk_size_ = 246,     /* --param=parloops-chunk-size= */
  OPT__param_parloops_min_per_thread_ = 247, /* --param=parloops-min-per-thread= */
  OPT__param_parloops_schedule_ = 248,       /* --param=parloops-schedule= */
  OPT__param_partial_inlining_entry_probability_ = 249,/* --param=partial-inlining-entry-probability= */
  OPT__param_predictable_branch_outcome_ = 250,/* --param=predictable-branch-outcome= */
  OPT__param_prefetch_dynamic_strides_ = 251,/* --param=prefetch-dynamic-strides= */
  OPT__param_prefetch_latency_ = 252,        /* --param=prefetch-latency= */
  OPT__param_prefetch_min_insn_to_mem_ratio_ = 253,/* --param=prefetch-min-insn-to-mem-ratio= */
  OPT__param_prefetch_minimum_stride_ = 254, /* --param=prefetch-minimum-stride= */
  OPT__param_profile_func_internal_id_ = 255,/* --param=profile-func-internal-id= */
  OPT__param_rpo_vn_max_loop_depth_ = 256,   /* --param=rpo-vn-max-loop-depth= */
  OPT__param_sccvn_max_alias_queries_per_access_ = 257,/* --param=sccvn-max-alias-queries-per-access= */
  OPT__param_scev_max_expr_complexity_ = 258,/* --param=scev-max-expr-complexity= */
  OPT__param_scev_max_expr_size_ = 259,      /* --param=scev-max-expr-size= */
  OPT__param_sched_autopref_queue_depth_ = 260,/* --param=sched-autopref-queue-depth= */
  OPT__param_sched_mem_true_dep_cost_ = 261, /* --param=sched-mem-true-dep-cost= */
  OPT__param_sched_pressure_algorithm_ = 262,/* --param=sched-pressure-algorithm= */
  OPT__param_sched_spec_prob_cutoff_ = 263,  /* --param=sched-spec-prob-cutoff= */
  OPT__param_sched_state_edge_prob_cutoff_ = 264,/* --param=sched-state-edge-prob-cutoff= */
  OPT__param_selsched_insns_to_rename_ = 265,/* --param=selsched-insns-to-rename= */
  OPT__param_selsched_max_lookahead_ = 266,  /* --param=selsched-max-lookahead= */
  OPT__param_selsched_max_sched_times_ = 267,/* --param=selsched-max-sched-times= */
  OPT__param_simultaneous_prefetches_ = 268, /* --param=simultaneous-prefetches= */
  OPT__param_sink_frequency_threshold_ = 269,/* --param=sink-frequency-threshold= */
  OPT__param_slp_max_insns_in_bb_ = 270,     /* --param=slp-max-insns-in-bb= */
  OPT__param_sms_dfa_history_ = 271,         /* --param=sms-dfa-history= */
  OPT__param_sms_loop_average_count_threshold_ = 272,/* --param=sms-loop-average-count-threshold= */
  OPT__param_sms_max_ii_factor_ = 273,       /* --param=sms-max-ii-factor= */
  OPT__param_sms_min_sc_ = 274,              /* --param=sms-min-sc= */
  OPT__param_sra_max_propagations_ = 275,    /* --param=sra-max-propagations= */
  OPT__param_sra_max_scalarization_size_Osize_ = 276,/* --param=sra-max-scalarization-size-Osize= */
  OPT__param_sra_max_scalarization_size_Ospeed_ = 277,/* --param=sra-max-scalarization-size-Ospeed= */
  OPT__param_ssa_name_def_chain_limit_ = 278,/* --param=ssa-name-def-chain-limit= */
  OPT__param_ssp_buffer_size_ = 279,         /* --param=ssp-buffer-size= */
  OPT__param_stack_clash_protection_guard_size_ = 280,/* --param=stack-clash-protection-guard-size= */
  OPT__param_stack_clash_protection_probe_interval_ = 281,/* --param=stack-clash-protection-probe-interval= */
  OPT__param_store_merging_allow_unaligned_ = 282,/* --param=store-merging-allow-unaligned= */
  OPT__param_store_merging_max_size_ = 283,  /* --param=store-merging-max-size= */
  OPT__param_switch_conversion_max_branch_ratio_ = 284,/* --param=switch-conversion-max-branch-ratio= */
  OPT__param_tm_max_aggregate_size_ = 285,   /* --param=tm-max-aggregate-size= */
  OPT__param_tracer_dynamic_coverage_feedback_ = 286,/* --param=tracer-dynamic-coverage-feedback= */
  OPT__param_tracer_dynamic_coverage_ = 287, /* --param=tracer-dynamic-coverage= */
  OPT__param_tracer_max_code_growth_ = 288,  /* --param=tracer-max-code-growth= */
  OPT__param_tracer_min_branch_probability_feedback_ = 289,/* --param=tracer-min-branch-probability-feedback= */
  OPT__param_tracer_min_branch_probability_ = 290,/* --param=tracer-min-branch-probability= */
  OPT__param_tracer_min_branch_ratio_ = 291, /* --param=tracer-min-branch-ratio= */
  OPT__param_tree_reassoc_width_ = 292,      /* --param=tree-reassoc-width= */
  OPT__param_tsan_distinguish_volatile_ = 293,/* --param=tsan-distinguish-volatile= */
  OPT__param_tsan_instrument_func_entry_exit_ = 294,/* --param=tsan-instrument-func-entry-exit= */
  OPT__param_uninit_control_dep_attempts_ = 295,/* --param=uninit-control-dep-attempts= */
  OPT__param_uninlined_function_insns_ = 296,/* --param=uninlined-function-insns= */
  OPT__param_uninlined_function_time_ = 297, /* --param=uninlined-function-time= */
  OPT__param_uninlined_thunk_insns_ = 298,   /* --param=uninlined-thunk-insns= */
  OPT__param_uninlined_thunk_time_ = 299,    /* --param=uninlined-thunk-time= */
  OPT__param_unlikely_bb_count_fraction_ = 300,/* --param=unlikely-bb-count-fraction= */
  OPT__param_unroll_jam_max_unroll_ = 301,   /* --param=unroll-jam-max-unroll= */
  OPT__param_unroll_jam_min_percent_ = 302,  /* --param=unroll-jam-min-percent= */
  OPT__param_use_after_scope_direct_emission_threshold_ = 303,/* --param=use-after-scope-direct-emission-threshold= */
  OPT__param_use_canonical_types_ = 304,     /* --param=use-canonical-types= */
  OPT__param_vect_epilogues_nomask_ = 305,   /* --param=vect-epilogues-nomask= */
  OPT__param_vect_max_peeling_for_alignment_ = 306,/* --param=vect-max-peeling-for-alignment= */
  OPT__param_vect_max_version_for_alias_checks_ = 307,/* --param=vect-max-version-for-alias-checks= */
  OPT__param_vect_max_version_for_alignment_checks_ = 308,/* --param=vect-max-version-for-alignment-checks= */
  OPT__param_vect_partial_vector_usage_ = 309,/* --param=vect-partial-vector-usage= */
  /* OPT__pass_exit_codes = 310, */          /* --pass-exit-codes */
  /* OPT__pedantic = 311, */                 /* --pedantic */
  /* OPT__pedantic_errors = 312, */          /* --pedantic-errors */
  /* OPT__pie = 313, */                      /* --pie */
  /* OPT__pipe = 314, */                     /* --pipe */
  /* OPT__prefix = 315, */                   /* --prefix */
  /* OPT__prefix_ = 316, */                  /* --prefix= */
  /* OPT__preprocess = 317, */               /* --preprocess */
  /* OPT__print_file_name = 318, */          /* --print-file-name */
  /* OPT__print_file_name_ = 319, */         /* --print-file-name= */
  /* OPT__print_libgcc_file_name = 320, */   /* --print-libgcc-file-name */
  /* OPT__print_missing_file_dependencies = 321, *//* --print-missing-file-dependencies */
  /* OPT__print_multi_directory = 322, */    /* --print-multi-directory */
  /* OPT__print_multi_lib = 323, */          /* --print-multi-lib */
  /* OPT__print_multi_os_directory = 324, */ /* --print-multi-os-directory */
  /* OPT__print_multiarch = 325, */          /* --print-multiarch */
  /* OPT__print_prog_name = 326, */          /* --print-prog-name */
  /* OPT__print_prog_name_ = 327, */         /* --print-prog-name= */
  /* OPT__print_search_dirs = 328, */        /* --print-search-dirs */
  /* OPT__print_sysroot = 329, */            /* --print-sysroot */
  /* OPT__print_sysroot_headers_suffix = 330, *//* --print-sysroot-headers-suffix */
  /* OPT__profile = 331, */                  /* --profile */
  /* OPT__save_temps = 332, */               /* --save-temps */
  /* OPT__shared = 333, */                   /* --shared */
  /* OPT__specs = 334, */                    /* --specs */
  /* OPT__specs_ = 335, */                   /* --specs= */
  /* OPT__static = 336, */                   /* --static */
  /* OPT__static_pie = 337, */               /* --static-pie */
  /* OPT__symbolic = 338, */                 /* --symbolic */
  /* OPT__sysroot = 339, */                  /* --sysroot */
  OPT__sysroot_ = 340,                       /* --sysroot= */
  OPT__target_help = 341,                    /* --target-help */
  /* OPT__time = 342, */                     /* --time */
  /* OPT__trace_includes = 343, */           /* --trace-includes */
  /* OPT__traditional = 344, */              /* --traditional */
  /* OPT__traditional_cpp = 345, */          /* --traditional-cpp */
  /* OPT__trigraphs = 346, */                /* --trigraphs */
  /* OPT__undefine_macro = 347, */           /* --undefine-macro */
  /* OPT__undefine_macro_ = 348, */          /* --undefine-macro= */
  /* OPT__user_dependencies = 349, */        /* --user-dependencies */
  /* OPT__verbose = 350, */                  /* --verbose */
  OPT__version = 351,                        /* --version */
  /* OPT__write_dependencies = 352, */       /* --write-dependencies */
  /* OPT__write_user_dependencies = 353, */  /* --write-user-dependencies */
  OPT_A = 354,                               /* -A */
  OPT_B = 355,                               /* -B */
  OPT_C = 356,                               /* -C */
  OPT_CC = 357,                              /* -CC */
  ...
  OPT_Tbss_ = 389,                           /* -Tbss= */
  OPT_Tdata = 390,                           /* -Tdata */
  OPT_Tdata_ = 391,                          /* -Tdata= */
  OPT_Ttext = 392,                           /* -Ttext */
  OPT_Ttext_ = 393,                          /* -Ttext= */
  OPT_U = 394,                               /* -U */
  /* OPT_W = 395, */                         /* -W */
  OPT_Wa_ = 396,                             /* -Wa, */
  OPT_Wabi = 397,                            /* -Wabi */
  OPT_Wabi_tag = 398,                        /* -Wabi-tag */
  OPT_Wabi_ = 399,                           /* -Wabi= */
  OPT_Wabsolute_value = 400,                 /* -Wabsolute-value */
  OPT_Waddress = 401,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 402,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 403,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 404,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 405,                       /* -Waliasing */
  OPT_Walign_commons = 406,                  /* -Walign-commons */
  /* OPT_Waligned_new = 407, */              /* -Waligned-new */
  OPT_Waligned_new_ = 408,                   /* -Waligned-new= */
  OPT_Wall = 409,                            /* -Wall */
  OPT_Walloc_size_larger_than_ = 410,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 411,                     /* -Walloc-zero */
  OPT_Walloca = 412,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 413,            /* -Walloca-larger-than= */
  OPT_Wampersand = 414,                      /* -Wampersand */
  OPT_Wanalyzer_double_fclose = 415,         /* -Wanalyzer-double-fclose */
  OPT_Wanalyzer_double_free = 416,           /* -Wanalyzer-double-free */
  OPT_Wanalyzer_exposure_through_output_file = 417,/* -Wanalyzer-exposure-through-output-file */
  OPT_Wanalyzer_file_leak = 418,             /* -Wanalyzer-file-leak */
  OPT_Wanalyzer_free_of_non_heap = 419,      /* -Wanalyzer-free-of-non-heap */
  OPT_Wanalyzer_malloc_leak = 420,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_mismatching_deallocation = 421,/* -Wanalyzer-mismatching-deallocation */
  OPT_Wanalyzer_null_argument = 422,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 423,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_possible_null_argument = 424,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 425,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_stale_setjmp_buffer = 426,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_tainted_array_index = 427,   /* -Wanalyzer-tainted-array-index */
  OPT_Wanalyzer_too_complex = 428,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 429,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 430,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 431,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wargument_mismatch = 432,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 433,               /* -Warith-conversion */
  OPT_Warray_bounds = 434,                   /* -Warray-bounds */
  OPT_Warray_bounds_ = 435,                  /* -Warray-bounds= */
  /* OPT_Warray_parameter = 436, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 437,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 438,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 439,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 440, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 441,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 442,              /* -Wattribute-warning */
  OPT_Wattributes = 443,                     /* -Wattributes */
  OPT_Wbad_function_cast = 444,              /* -Wbad-function-cast */
  OPT_Wbool_compare = 445,                   /* -Wbool-compare */
  OPT_Wbool_operation = 446,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 447,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 448,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 449,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 450, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 451,                   /* -Wc++11-compat */
  OPT_Wc__14_compat = 452,                   /* -Wc++14-compat */
  OPT_Wc__17_compat = 453,                   /* -Wc++17-compat */
  /* OPT_Wc__1z_compat = 454, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 455,                   /* -Wc++20-compat */
  /* OPT_Wc__2a_compat = 456, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 457,                 /* -Wc-binding-type */
  OPT_Wc11_c2x_compat = 458,                 /* -Wc11-c2x-compat */
  OPT_Wc90_c99_compat = 459,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 460,                 /* -Wc99-c11-compat */
  OPT_Wcannot_profile = 461,                 /* -Wcannot-profile */
  OPT_Wcast_align = 462,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 463,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 464,             /* -Wcast-function-type */
  OPT_Wcast_qual = 465,                      /* -Wcast-qual */
  OPT_Wcast_result = 466,                    /* -Wcast-result */
  /* OPT_Wcatch_value = 467, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 468,                   /* -Wcatch-value= */
  OPT_Wchar_subscripts = 469,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 470,           /* -Wcharacter-truncation */
  OPT_Wchkp = 471,                           /* -Wchkp */
  OPT_Wclass_conversion = 472,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 473,                /* -Wclass-memaccess */
  OPT_Wclobbered = 474,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 475,                /* -Wcomma-subscript */
  OPT_Wcomment = 476,                        /* -Wcomment */
  /* OPT_Wcomments = 477, */                 /* -Wcomments */
  OPT_Wcompare_reals = 478,                  /* -Wcompare-reals */
  OPT_Wconditionally_supported = 479,        /* -Wconditionally-supported */
  OPT_Wconversion = 480,                     /* -Wconversion */
  OPT_Wconversion_extra = 481,               /* -Wconversion-extra */
  OPT_Wconversion_null = 482,                /* -Wconversion-null */
  OPT_Wcoverage_mismatch = 483,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 484,                            /* -Wcpp */
  OPT_Wctad_maybe_unsupported = 485,         /* -Wctad-maybe-unsupported */
  OPT_Wctor_dtor_privacy = 486,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 487,                  /* -Wdangling-else */
  OPT_Wdate_time = 488,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 489,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 490,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 491,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 492,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 493,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 494,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 495,        /* -Wdeprecated-declarations */
  OPT_Wdesignated_init = 496,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 497,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 498,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 499,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 500,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 501,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 502,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 503,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 504,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 505,                /* -Wduplicated-cond */
  OPT_Weffc__ = 506,                         /* -Weffc++ */
  OPT_Wempty_body = 507,                     /* -Wempty-body */
  OPT_Wendif_labels = 508,                   /* -Wendif-labels */
  OPT_Wenum_compare = 509,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 510,                /* -Wenum-conversion */
  OPT_Werror = 511,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 512, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 513,                         /* -Werror= */
  OPT_Wexpansion_to_defined = 514,           /* -Wexpansion-to-defined */
  OPT_Wextra = 515,                          /* -Wextra */
  OPT_Wextra_semi = 516,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 517,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 518,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 519,                    /* -Wfloat-equal */
  /* OPT_Wformat = 520, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 521,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 522,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 523,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 524,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 525, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 526,               /* -Wformat-overflow= */
  OPT_Wformat_security = 527,                /* -Wformat-security */
  OPT_Wformat_signedness = 528,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 529, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 530,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 531,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 532,             /* -Wformat-zero-length */
  OPT_Wformat_ = 533,                        /* -Wformat= */
  OPT_Wframe_address = 534,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 535,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 536,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 537,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 538,           /* -Wfunction-elimination */
  /* OPT_Whsa = 539, */                      /* -Whsa */
  OPT_Wif_not_aligned = 540,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 541,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 542,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 543,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 544, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 545,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 546,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 547,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 548,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 549,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 550, */                   /* -Wimport */
  OPT_Winaccessible_base = 551,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 552,     /* -Wincompatible-pointer-types */
  OPT_Winherited_variadic_ctor = 553,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 554,             /* -Winit-list-lifetime */
  OPT_Winit_self = 555,                      /* -Winit-self */
  OPT_Winline = 556,                         /* -Winline */
  OPT_Wint_conversion = 557,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 558,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 559,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 560,               /* -Winteger-division */
  OPT_Wintrinsic_shadow = 561,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 562,                 /* -Wintrinsics-std */
  OPT_Winvalid_memory_model = 563,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 564,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 565,                    /* -Winvalid-pch */
  OPT_Wjump_misses_init = 566,               /* -Wjump-misses-init */
  OPT_Wl_ = 567,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 568, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 569,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 570,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 571,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 572,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 573,                     /* -Wlogical-op */
  OPT_Wlong_long = 574,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 575,              /* -Wlto-type-mismatch */
  OPT_Wmain = 576,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 577,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 578,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 579,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 580,         /* -Wmisleading-indentation */
  OPT_Wmismatched_tags = 581,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 582,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 583,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 584,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 585,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 586, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 587,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 588, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 589,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 590,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 591,             /* -Wmissing-prototypes */
  OPT_Wmudflap = 592,                        /* -Wmudflap */
  OPT_Wmultichar = 593,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 594,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 595,          /* -Wmultistatement-macros */
  OPT_Wnamespaces = 596,                     /* -Wnamespaces */
  OPT_Wnarrowing = 597,                      /* -Wnarrowing */
  OPT_Wnested_externs = 598,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 599, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 600, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 601, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 602, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 603, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 604, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 605,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 606,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 607,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 608,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 609,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 610,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 611, */               /* -Wnormalized */
  OPT_Wnormalized_ = 612,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 613,               /* -Wnull-dereference */
  OPT_Wodr = 614,                            /* -Wodr */
  OPT_Wold_style_cast = 615,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 616,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 617,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 618,                    /* -Wopenmp-simd */
  OPT_Woverflow = 619,                       /* -Woverflow */
  OPT_Woverlength_strings = 620,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 621,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 622,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 623,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 624,            /* -Woverwrite-recursive */
  OPT_Wp_ = 625,                             /* -Wp, */
  OPT_Wpacked = 626,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 627,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 628,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 629,                         /* -Wpadded */
  OPT_Wparentheses = 630,                    /* -Wparentheses */
  OPT_Wpedantic = 631,                       /* -Wpedantic */
  OPT_Wpessimizing_move = 632,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 633, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 634,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 635,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 636,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 637,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 638,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 639,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 640,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 641,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 642,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 643,                       /* -Wprotocol */
  OPT_Wpsabi = 644,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 645,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 646,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 647,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 648,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 649,                /* -Wredundant-decls */
  OPT_Wredundant_move = 650,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 651,                 /* -Wredundant-tags */
  OPT_Wregister = 652,                       /* -Wregister */
  OPT_Wreorder = 653,                        /* -Wreorder */
  OPT_Wrestrict = 654,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 655,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 656,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 657,           /* -Wscalar-storage-order */
  OPT_Wselector = 658,                       /* -Wselector */
  OPT_Wsequence_point = 659,                 /* -Wsequence-point */
  OPT_Wshadow = 660,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 661, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 662,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 663, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 664,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 665, */            /* -Wshadow=global */
  OPT_Wshadow_local = 666,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 667,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 668,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 669,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 670, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 671,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 672,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 673,                /* -Wsign-conversion */
  OPT_Wsign_promo = 674,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 675,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 676,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_div = 677,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 678,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 679,                    /* -Wspeculative */
  OPT_Wstack_protector = 680,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 681,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 682,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 683,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 684,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 685,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 686,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 687,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 688,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 689,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 690, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 691,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 692,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 693,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 694,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 695,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 696,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 697,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 698,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 699,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 700,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 701,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 702,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 703,               /* -Wsuggest-override */
  OPT_Wsurprising = 704,                     /* -Wsurprising */
  OPT_Wswitch = 705,                         /* -Wswitch */
  OPT_Wswitch_bool = 706,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 707,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 708,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 709,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 710,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 711,                      /* -Wsync-nand */
  OPT_Wsynth = 712,                          /* -Wsynth */
  OPT_Wsystem_headers = 713,                 /* -Wsystem-headers */
  OPT_Wtabs = 714,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 715,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 716,           /* -Wtautological-compare */
  OPT_Wtemplates = 717,                      /* -Wtemplates */
  OPT_Wterminate = 718,                      /* -Wterminate */
  OPT_Wtraditional = 719,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 720,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 721,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 722,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 723,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 724,            /* -Wundeclared-selector */
  OPT_Wundef = 725,                          /* -Wundef */
  OPT_Wundefined_do_loop = 726,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 727,                      /* -Wunderflow */
  OPT_Wuninitialized = 728,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 729,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 730, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 731, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 732,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 733,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 734,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 735,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 736, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 737,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 738,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 739,                /* -Wunused-function */
  OPT_Wunused_label = 740,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 741,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 742,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 743,               /* -Wunused-parameter */
  OPT_Wunused_result = 744,                  /* -Wunused-result */
  OPT_Wunused_value = 745,                   /* -Wunused-value */
  OPT_Wunused_variable = 746,                /* -Wunused-variable */
  OPT_Wuse_without_only = 747,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 748,                   /* -Wuseless-cast */
  OPT_Wvarargs = 749,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 750,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 751,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 752,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 753,            /* -Wvirtual-move-assign */
  OPT_Wvla = 754,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 755,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 756,                  /* -Wvla-parameter */
  OPT_Wvolatile = 757,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 758,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 759,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 760,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 761,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 762,                       /* -Wzerotrip */
  OPT_X = 763,                               /* -X */
  OPT_Xassembler = 764,                      /* -Xassembler */
  OPT_Xf = 765,                              /* -Xf */
  OPT_Xlinker = 766,                         /* -Xlinker */
  OPT_Xpreprocessor = 767,                   /* -Xpreprocessor */
  OPT_Z = 768,                               /* -Z */
  OPT_ansi = 769,                            /* -ansi */
  OPT_aux_info = 770,                        /* -aux-info */
  /* OPT_aux_info_ = 771, */                 /* -aux-info= */
  OPT_c = 772,                               /* -c */
  OPT_callgraph = 773,                       /* -callgraph */
  OPT_coverage = 774,                        /* -coverage */
  OPT_cpp = 775,                             /* -cpp */
  OPT_cpp_ = 776,                            /* -cpp= */
  OPT_d = 777,                               /* -d */
  OPT_debuglib_ = 778,                       /* -debuglib= */
  OPT_defaultlib_ = 779,                     /* -defaultlib= */
  OPT_defined_only = 780,                    /* -defined-only */
  OPT_demangle = 781,                        /* -demangle */
  OPT_dstartfiles = 782,                     /* -dstartfiles */
  OPT_dump_body_ = 783,                      /* -dump-body= */
  OPT_dump_level_ = 784,                     /* -dump-level= */
  OPT_dumpbase = 785,                        /* -dumpbase */
  OPT_dumpbase_ext = 786,                    /* -dumpbase-ext */
  OPT_dumpdir = 787,                         /* -dumpdir */
  OPT_dumpfullversion = 788,                 /* -dumpfullversion */
  OPT_dumpmachine = 789,                     /* -dumpmachine */
  OPT_dumpspecs = 790,                       /* -dumpspecs */
  OPT_dumpversion = 791,                     /* -dumpversion */
  OPT_e = 792,                               /* -e */
  OPT_export_dynamic = 793,                  /* -export-dynamic */
  OPT_fPIC = 794,                            /* -fPIC */
  OPT_fPIE = 795,                            /* -fPIE */
  OPT_fRTS_ = 796,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 797,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 798,                   /* -fabi-version= */
  OPT_faccess_control = 799,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 800,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 801,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 802,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 803,                  /* -falign-commons */
  OPT_falign_functions = 804,                /* -falign-functions */
  OPT_falign_functions_ = 805,               /* -falign-functions= */
  OPT_falign_jumps = 806,                    /* -falign-jumps */
  OPT_falign_jumps_ = 807,                   /* -falign-jumps= */
  OPT_falign_labels = 808,                   /* -falign-labels */
  OPT_falign_labels_ = 809,                  /* -falign-labels= */
  OPT_falign_loops = 810,                    /* -falign-loops */
  OPT_falign_loops_ = 811,                   /* -falign-loops= */
  /* OPT_faligned_new = 812, */              /* -faligned-new */
  OPT_faligned_new_ = 813,                   /* -faligned-new= */
  OPT_fall_instantiations = 814,             /* -fall-instantiations */
  OPT_fall_intrinsics = 815,                 /* -fall-intrinsics */
  OPT_fall_virtual = 816,                    /* -fall-virtual */
  OPT_fallocation_dce = 817,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 818,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 819,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 820,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 821,/* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 822,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 823,         /* -falt-external-templates */
  OPT_fanalyzer = 824,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 825,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 826,              /* -fanalyzer-checker= */
  OPT_fanalyzer_feasibility = 827,           /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 828,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 829,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_state_merge = 830,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 831,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_transitivity = 832,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_verbose_edges = 833,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 834, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 835,            /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 836, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 837, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 838, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 839, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 840,            /* -fasan-shadow-offset= */
  OPT_fasm = 841,                            /* -fasm */
  OPT_fassert = 842,                         /* -fassert */
  OPT_fassociative_math = 843,               /* -fassociative-math */
  OPT_fassume_phsa = 844,                    /* -fassume-phsa */
  OPT_fasynchronous_unwind_tables = 845,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 846,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 847,                   /* -fauto-profile */
  OPT_fauto_profile_ = 848,                  /* -fauto-profile= */
  OPT_fautomatic = 849,                      /* -fautomatic */
  OPT_fbackslash = 850,                      /* -fbackslash */
  OPT_fbacktrace = 851,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 852,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 853,                   /* -fbounds-check */
  OPT_fbounds_check_ = 854,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 855,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 856,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 857, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 858, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 859, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 860,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 861,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 862,                        /* -fbuiltin */
  OPT_fbuiltin_ = 863,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 864,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 865,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 866,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 867,                    /* -fcall-saved- */
  OPT_fcall_used_ = 868,                     /* -fcall-used- */
  OPT_fcaller_saves = 869,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 870,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 871,                /* -fcallgraph-info= */
  OPT_fcanonical_system_headers = 872,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 873, */            /* -fcf-protection */
  OPT_fcf_protection_ = 874,                 /* -fcf-protection= */
  OPT_fchar8_t = 875,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 876,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 877, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 878,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 879,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 880,                         /* -fcheck= */
  OPT_fchecking = 881,                       /* -fchecking */
  OPT_fchecking_ = 882,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 883,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 884,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 885,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 886,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 887,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 888,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 889,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 890,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 891, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 892,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 893,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 894,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 895, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 896,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 897,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 898,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 899,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 900,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 901, */                 /* -fcilkplus */
  OPT_fcoarray_ = 902,                       /* -fcoarray= */
  OPT_fcode_hoisting = 903,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 904,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 905,                         /* -fcommon */
  OPT_fcompare_debug = 906,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 907,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 908,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 909,                   /* -fcompare-elim */
  OPT_fconcepts = 910,                       /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 911,    /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 912,                    /* -fconcepts-ts */
  OPT_fcond_mismatch = 913,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 914, */           /* -fconserve-space */
  OPT_fconserve_stack = 915,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 916,         /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 917,         /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 918,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 919,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 920,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 921,                       /* -fconvert= */
  OPT_fcoroutines = 922,                     /* -fcoroutines */
  OPT_fcprop_registers = 923,                /* -fcprop-registers */
  OPT_fcray_pointer = 924,                   /* -fcray-pointer */
  OPT_fcrossjumping = 925,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 926,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 927, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 928,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 929,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 930,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 931,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 932,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 933,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 934,                       /* -fdbg-cnt= */
  OPT_fdce = 935,                            /* -fdce */
  OPT_fdebug = 936,                          /* -fdebug */
  OPT_fdebug_cpp = 937,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 938,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 939,            /* -fdebug-types-section */
  OPT_fdebug_ = 940,                         /* -fdebug= */
  OPT_fdec = 941,                            /* -fdec */
  OPT_fdec_blank_format_item = 942,          /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 943,           /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 944,            /* -fdec-format-defaults */
  OPT_fdec_include = 945,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 946,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 947,                       /* -fdec-math */
  OPT_fdec_static = 948,                     /* -fdec-static */
  OPT_fdec_structure = 949,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 950,              /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 951, */         /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 952,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 953, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 954,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 955,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 956,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 957,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 958,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 959,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 960,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 961,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 962,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 963,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 964,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 965, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 966,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 967,     /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 968,       /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_format_ = 969,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 970,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 971,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 972,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 973,       /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 974,       /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_show_caret = 975,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 976,           /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 977,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 978,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 979,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 980,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 981,   /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_template_tree = 982, /* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 983,              /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 984,                /* -fdirectives-only */
  OPT_fdisable_ = 985,                       /* -fdisable- */
  OPT_fdoc = 986,                            /* -fdoc */
  OPT_fdoc_dir_ = 987,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 988,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 989,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 990,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 991,         /* -fdollars-in-identifiers */
  OPT_fdruntime = 992,                       /* -fdruntime */
  OPT_fdse = 993,                            /* -fdse */
  OPT_fdump_ = 994,                          /* -fdump- */
  OPT_fdump_ada_spec = 995,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 996,             /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 997,                  /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 998,        /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 999,   /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1000,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1001,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1002,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_json = 1003,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1004,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1005,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1006,      /* -fdump-analyzer-supergraph */
  /* OPT_fdump_core = 1007, */               /* -fdump-core */
  OPT_fdump_d_original = 1008,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1009,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1010,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1011,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1012,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1013,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1014,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1015,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1016,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1017, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1018,                   /* -fdump-passes */
  OPT_fdump_scos = 1019,                     /* -fdump-scos */
  OPT_fdump_unnumbered = 1020,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1021,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1022,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1023,                /* -fearly-inlining */
  OPT_felide_constructors = 1024,            /* -felide-constructors */
  OPT_felide_type = 1025,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1026, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1027,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1028,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1029,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1030,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1031,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1032,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1033,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1034,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1035,                /* -fenum-int-equiv */
  OPT_fexceptions = 1036,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1037,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1038,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1039,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1040,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1041,          /* -fextended-identifiers */
  OPT_fextern_tls_init = 1042,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1043,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1044,            /* -fexternal-templates */
  OPT_ff2c = 1045,                           /* -ff2c */
  OPT_ffast_math = 1046,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1047,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1048,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1049,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1050,              /* -ffinite-math-only */
  OPT_ffixed_ = 1051,                        /* -ffixed- */
  OPT_ffixed_form = 1052,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1053,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1054,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1055,                   /* -ffloat-store */
  OPT_ffor_scope = 1056,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1057, */              /* -fforce-addr */
  OPT_fforward_propagate = 1058,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1059,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1060,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1061,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1062,                     /* -ffpe-trap= */
  OPT_ffree_form = 1063,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1064,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1065,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1066,                  /* -ffreestanding */
  OPT_ffriend_injection = 1067,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1068,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1069,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1070,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1071,             /* -ffunction-sections */
  OPT_fgcse = 1072,                          /* -fgcse */
  OPT_fgcse_after_reload = 1073,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1074,                      /* -fgcse-las */
  OPT_fgcse_lm = 1075,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1076,                       /* -fgcse-sm */
  OPT_fgimple = 1077,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1078,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1079,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1080,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1081,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1082,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1083,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1084,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1085,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1086,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1087,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1088,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1089,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1090,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1091,                      /* -fgo-dump- */
  OPT_fgo_optimize_ = 1092,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1093,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1094,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1095,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1096,                      /* -fgraphite */
  OPT_fgraphite_identity = 1097,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1098,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1099,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1100, */       /* -fhandle-exceptions */
  /* OPT_fhelp = 1101, */                    /* -fhelp */
  /* OPT_fhelp_ = 1102, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1103,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1104,                     /* -fhonor-std */
  OPT_fhosted = 1105,                        /* -fhosted */
  OPT_fhuge_objects = 1106,                  /* -fhuge-objects */
  OPT_fident = 1107,                         /* -fident */
  OPT_fif_conversion = 1108,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1109,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1110,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1111,             /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 1112,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1113,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1114,            /* -fimplicit-templates */
  OPT_findirect_inlining = 1115,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1116,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1117,               /* -finit-character= */
  OPT_finit_derived = 1118,                  /* -finit-derived */
  OPT_finit_integer_ = 1119,                 /* -finit-integer= */
  OPT_finit_local_zero = 1120,               /* -finit-local-zero */
  OPT_finit_logical_ = 1121,                 /* -finit-logical= */
  OPT_finit_real_ = 1122,                    /* -finit-real= */
  OPT_finline = 1123,                        /* -finline */
  OPT_finline_arg_packing = 1124,            /* -finline-arg-packing */
  OPT_finline_atomics = 1125,                /* -finline-atomics */
  OPT_finline_functions = 1126,              /* -finline-functions */
  OPT_finline_functions_called_once = 1127,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1128, */           /* -finline-limit- */
  OPT_finline_limit_ = 1129,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1130,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1131,        /* -finline-small-functions */
  OPT_finput_charset_ = 1132,                /* -finput-charset= */
  OPT_finstrument_functions = 1133,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1134,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1135,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 1136,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1137,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1138,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1139,                    /* -finvariants */
  OPT_fipa_bit_cp = 1140,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1141,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1142, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1143,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1144,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1145,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1146,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1147, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1148,                    /* -fipa-modref */
  OPT_fipa_profile = 1149,                   /* -fipa-profile */
  OPT_fipa_pta = 1150,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1151,                /* -fipa-pure-const */
  OPT_fipa_ra = 1152,                        /* -fipa-ra */
  OPT_fipa_reference = 1153,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1154,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1155,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1156,           /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 1157, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1158,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1159,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1160,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1161,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1162,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1163,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1164,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1165,                  /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 1166,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1167,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1168,              /* -fivar-visibility= */
  OPT_fivopts = 1169,                        /* -fivopts */
  OPT_fjump_tables = 1170,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1171,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1172,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1173,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1174,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1175,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1176,                     /* -flabels-ok */
  OPT_flarge_source_files = 1177,            /* -flarge-source-files */
  OPT_flax_vector_conversions = 1178,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1179,            /* -fleading-underscore */
  OPT_flifetime_dse = 1180,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1181,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1182,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1183,                /* -flinker-output= */
  /* OPT_flive_patching = 1184, */           /* -flive-patching */
  OPT_flive_patching_ = 1185,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1186,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1187,                   /* -flocal-ivars */
  /* OPT_floop_block = 1188, */              /* -floop-block */
  /* OPT_floop_flatten = 1189, */            /* -floop-flatten */
  OPT_floop_interchange = 1190,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1191,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1192, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1193,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1194, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1195,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1196,                     /* -flra-remat */
  OPT_flto = 1197,                           /* -flto */
  OPT_flto_compression_level_ = 1198,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1199, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1200,                /* -flto-partition= */
  OPT_flto_report = 1201,                    /* -flto-report */
  OPT_flto_report_wpa = 1202,                /* -flto-report-wpa */
  OPT_flto_ = 1203,                          /* -flto= */
  OPT_fltrans = 1204,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1205,           /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 1206,             /* -fmacro-prefix-map= */
  OPT_fmain = 1207,                          /* -fmain */
  OPT_fmath_errno = 1208,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1209,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1210,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1211,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1212,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1213,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1214,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1215,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1216,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1217,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1218,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1219,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1220,               /* -fmessage-length= */
  OPT_fmodule_file_ = 1221,                  /* -fmodule-file= */
  OPT_fmodule_private = 1222,                /* -fmodule-private */
  OPT_fmoduleinfo = 1223,                    /* -fmoduleinfo */
  OPT_fmodulo_sched = 1224,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1225,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1226,          /* -fmove-loop-invariants */
  OPT_fms_extensions = 1227,                 /* -fms-extensions */
  OPT_fmudflap = 1228,                       /* -fmudflap */
  OPT_fmudflapir = 1229,                     /* -fmudflapir */
  OPT_fmudflapth = 1230,                     /* -fmudflapth */
  OPT_fname_mangling_version_ = 1231,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1232,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1233,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1234,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1235,                  /* -fnext-runtime */
  OPT_fnil_receivers = 1236,                 /* -fnil-receivers */
  OPT_fnon_call_exceptions = 1237,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1238,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1239,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1240,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1241,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1242,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1243,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1244,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1245,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1246,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1247,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1248,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1249,                  /* -foffload-abi= */
  OPT_foffload_ = 1250,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1251,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1252,                         /* -fonly= */
  OPT_fopenacc = 1253,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1254,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1255,                        /* -fopenmp */
  OPT_fopenmp_simd = 1256,                   /* -fopenmp-simd */
  OPT_foperator_names = 1257,                /* -foperator-names */
  OPT_fopt_info = 1258,                      /* -fopt-info */
  OPT_fopt_info_ = 1259,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1260, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1261,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1262,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1263, */          /* -foptional-diags */
  OPT_fpack_derived = 1264,                  /* -fpack-derived */
  OPT_fpack_struct = 1265,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1266,                  /* -fpack-struct= */
  OPT_fpad_source = 1267,                    /* -fpad-source */
  OPT_fpartial_inlining = 1268,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1269,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1270,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1271,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1272,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1273,                    /* -fpeel-loops */
  OPT_fpeephole = 1274,                      /* -fpeephole */
  OPT_fpeephole2 = 1275,                     /* -fpeephole2 */
  OPT_fpermissive = 1276,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1277,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1278,                           /* -fpic */
  OPT_fpie = 1279,                           /* -fpie */
  OPT_fplan9_extensions = 1280,              /* -fplan9-extensions */
  OPT_fplt = 1281,                           /* -fplt */
  OPT_fplugin_arg_ = 1282,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1283,                       /* -fplugin= */
  OPT_fpost_ipa_mem_report = 1284,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1285,                /* -fpostconditions */
  OPT_fpre_include_ = 1286,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1287,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1288,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1289,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1290,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1291,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1292,              /* -fpretty-templates */
  OPT_fprintf_return_value = 1293,           /* -fprintf-return-value */
  OPT_fprofile = 1294,                       /* -fprofile */
  OPT_fprofile_abs_path = 1295,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1296,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1297,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1298,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1299,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1300,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1301,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1302,             /* -fprofile-generate= */
  OPT_fprofile_note_ = 1303,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1304,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_path_ = 1305,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1306,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1307,                /* -fprofile-report */
  OPT_fprofile_reproducible = 1308,          /* -fprofile-reproducible */
  OPT_fprofile_update_ = 1309,               /* -fprofile-update= */
  OPT_fprofile_use = 1310,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1311,                  /* -fprofile-use= */
  OPT_fprofile_values = 1312,                /* -fprofile-values */
  OPT_fprotect_parens = 1313,                /* -fprotect-parens */
  OPT_frandom_seed = 1314,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1315,                  /* -frandom-seed= */
  OPT_frange_check = 1316,                   /* -frange-check */
  OPT_freal_4_real_10 = 1317,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1318,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1319,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1320,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1321,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1322,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1323,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1324,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1325,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1326,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1327,               /* -frecord-marker=8 */
  OPT_frecursive = 1328,                     /* -frecursive */
  OPT_free = 1329,                           /* -free */
  OPT_freg_struct_return = 1330,             /* -freg-struct-return */
  /* OPT_fregmove = 1331, */                 /* -fregmove */
  OPT_frelease = 1332,                       /* -frelease */
  OPT_frename_registers = 1333,              /* -frename-registers */
  OPT_freorder_blocks = 1334,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1335,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1336,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1337,             /* -freorder-functions */
  OPT_frepack_arrays = 1338,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1339,          /* -freplace-objc-classes */
  OPT_frepo = 1340,                          /* -frepo */
  OPT_freport_bug = 1341,                    /* -freport-bug */
  OPT_frequire_return_statement = 1342,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1343,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1344, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1345,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1346,                   /* -fresolution= */
  OPT_frounding_math = 1347,                 /* -frounding-math */
  OPT_frtti = 1348,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1349,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1350,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1351,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1352,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1353,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1354,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1355,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1356,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1357, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1358,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1359,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1360,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1361,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1362,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1363,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1364,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1365,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1366,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1367,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1368,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1369,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1370,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1371,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1372,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1373,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1374, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1375,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1376,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1377,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1378,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1379,               /* -fsection-anchors */
  /* OPT_fsee = 1380, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1381,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1382,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1383,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1384,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1385,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1386,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1387,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1388,                   /* -fshort-enums */
  OPT_fshort_wchar = 1389,                   /* -fshort-wchar */
  OPT_fshow_column = 1390,                   /* -fshow-column */
  OPT_fshrink_wrap = 1391,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1392,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1393,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1394,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1395,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1396,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1397,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1398,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1399,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1400,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1401,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1402,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1403,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1404,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1405,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1406,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1407,                      /* -fsquangle */
  OPT_fssa_backprop = 1408,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1409,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1410,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1411,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1412, */             /* -fstack-check */
  OPT_fstack_check_ = 1413,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1414,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1415,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1416,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1417,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1418,               /* -fstack-protector */
  OPT_fstack_protector_all = 1419,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1420,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1421,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1422,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1423,                   /* -fstack-usage */
  OPT_fstats = 1424,                         /* -fstats */
  OPT_fstdarg_opt = 1425,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1426,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1427, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1428,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1429,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1430,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1431,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1432,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1433, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1434,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1435,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1436,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1437,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1438,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1439, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1440,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1441, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1442,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1443, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1444,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1445,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1446,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1447,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1448,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1449,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1450,                   /* -ftime-report */
  OPT_ftime_report_details = 1451,           /* -ftime-report-details */
  OPT_ftls_model_ = 1452,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1453,              /* -ftoplevel-reorder */
  OPT_ftracer = 1454,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1455,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1456,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1457,                   /* -ftrampolines */
  OPT_ftransition_all = 1458,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1459,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1460,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1461,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1462,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1463,              /* -ftransition=field */
  OPT_ftransition_import = 1464,             /* -ftransition=import */
  OPT_ftransition_nogc = 1465,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1466,                /* -ftransition=tls */
  OPT_ftrapping_math = 1467,                 /* -ftrapping-math */
  OPT_ftrapv = 1468,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1469,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1470,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1471,                      /* -ftree-ccp */
  OPT_ftree_ch = 1472,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1473, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1474,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1475,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1476, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1477,                   /* -ftree-cselim */
  OPT_ftree_dce = 1478,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1479,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1480,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1481,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1482,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1483, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1484,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1485,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1486, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1487,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1488,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1489, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1490,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1491,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1492,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1493,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1494,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1495,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1496,                      /* -ftree-pre */
  OPT_ftree_pta = 1497,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1498,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1499, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1500,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1501,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1502,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1503,                     /* -ftree-slsr */
  OPT_ftree_sra = 1504,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1505, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1506, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1507,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1508,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1509,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1510, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1511,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1512, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1513,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1514,         /* -funconstrained-commons */
  OPT_funderscoring = 1515,                  /* -funderscoring */
  OPT_funit_at_a_time = 1516,                /* -funit-at-a-time */
  OPT_funittest = 1517,                      /* -funittest */
  OPT_funroll_all_loops = 1518,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1519,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1520,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1521, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1522,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1523,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1524,                 /* -funsigned-char */
  OPT_funswitch_loops = 1525,                /* -funswitch-loops */
  OPT_funwind_tables = 1526,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1527,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1528,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1529,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1530,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1531,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1532,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1533,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1534,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1535,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1536,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1537,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1538, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1539,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1540,                   /* -fverbose-asm */
  /* OPT_fversion = 1541, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1542,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1543,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1544,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1545,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1546,                   /* -fvisibility= */
  OPT_fvpt = 1547,                           /* -fvpt */
  OPT_fvtable_gc = 1548,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1549,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1550,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1551,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1552,                     /* -fvtv-debug */
  OPT_fweak = 1553,                          /* -fweak */
  OPT_fweb = 1554,                           /* -fweb */
  /* OPT_fwhole_file = 1555, */              /* -fwhole-file */
  OPT_fwhole_program = 1556,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1557,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1558,             /* -fworking-directory */
  OPT_fwpa = 1559,                           /* -fwpa */
  OPT_fwpa_ = 1560,                          /* -fwpa= */
  OPT_fwrapv = 1561,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1562,                 /* -fwrapv-pointer */
  OPT_fxref = 1563,                          /* -fxref */
  /* OPT_fzee = 1564, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1565,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1566,                     /* -fzero-link */
  OPT_g = 1567,                              /* -g */
  OPT_gant = 1568,                           /* -gant */
  OPT_gas_loc_support = 1569,                /* -gas-loc-support */
  OPT_gas_locview_support = 1570,            /* -gas-locview-support */
  OPT_gcoff = 1571,                          /* -gcoff */
  OPT_gcoff1 = 1572,                         /* -gcoff1 */
  OPT_gcoff2 = 1573,                         /* -gcoff2 */
  OPT_gcoff3 = 1574,                         /* -gcoff3 */
  OPT_gcolumn_info = 1575,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1576,                 /* -gdescribe-dies */
  OPT_gdwarf = 1577,                         /* -gdwarf */
  OPT_gdwarf_ = 1578,                        /* -gdwarf- */
  OPT_gen_decls = 1579,                      /* -gen-decls */
  OPT_ggdb = 1580,                           /* -ggdb */
  OPT_ggnu_pubnames = 1581,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1582,                   /* -gimple-stats */
  OPT_ginline_points = 1583,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1584, /* -ginternal-reset-location-views */
  OPT_gnat = 1585,                           /* -gnat */
  OPT_gnatO = 1586,                          /* -gnatO */
  OPT_gno_ = 1587,                           /* -gno- */
  OPT_gno_pubnames = 1588,                   /* -gno-pubnames */
  OPT_gpubnames = 1589,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1590,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1591,                   /* -gsplit-dwarf */
  OPT_gstabs = 1592,                         /* -gstabs */
  OPT_gstabs_ = 1593,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1594,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1595,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1596,                        /* -gtoggle */
  OPT_gvariable_location_views = 1597,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1598,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1599,                           /* -gvms */
  OPT_gxcoff = 1600,                         /* -gxcoff */
  OPT_gxcoff_ = 1601,                        /* -gxcoff+ */
  OPT_gz = 1602,                             /* -gz */
  OPT_gz_ = 1603,                            /* -gz= */
  OPT_h = 1604,                              /* -h */
  OPT_help = 1605,                           /* -help */
  OPT_idirafter = 1606,                      /* -idirafter */
  OPT_imacros = 1607,                        /* -imacros */
  OPT_imultiarch = 1608,                     /* -imultiarch */
  OPT_imultilib = 1609,                      /* -imultilib */
  OPT_include = 1610,                        /* -include */
  OPT_iplugindir_ = 1611,                    /* -iplugindir= */
  OPT_iprefix = 1612,                        /* -iprefix */
  OPT_iquote = 1613,                         /* -iquote */
  OPT_isysroot = 1614,                       /* -isysroot */
  OPT_isystem = 1615,                        /* -isystem */
  OPT_iwithprefix = 1616,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1617,              /* -iwithprefixbefore */
  OPT_k8 = 1618,                             /* -k8 */
  OPT_l = 1619,                              /* -l */
  OPT_lang_asm = 1620,                       /* -lang-asm */
  OPT_list = 1621,                           /* -list */
  OPT_mabi_ = 1622,                          /* -mabi= */
  OPT_march_ = 1623,                         /* -march= */
  OPT_mbig_endian = 1624,                    /* -mbig-endian */
  OPT_mbionic = 1625,                        /* -mbionic */
  OPT_mbranch_protection_ = 1626,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1627,                       /* -mcmodel= */
  OPT_mcpu_ = 1628,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1629,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1630,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1631,             /* -mgeneral-regs-only */
  OPT_mglibc = 1632,                         /* -mglibc */
  OPT_mharden_sls_ = 1633,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1634,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1635,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1636,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1637,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1638,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1639,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1640,               /* -moutline-atomics */
  OPT_moverride_ = 1641,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1642,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1643,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1644, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1645,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1646,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1647,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1648,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1649,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1650,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1651,             /* -mtrack-speculation */
  OPT_mtune_ = 1652,                         /* -mtune= */
  OPT_muclibc = 1653,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1654,             /* -mverbose-cost-dump */
  OPT_n = 1655,                              /* -n */
  OPT_name_sort = 1656,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1657,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1658,              /* -no-integrated-cpp */
  OPT_no_pie = 1659,                         /* -no-pie */
  OPT_nocpp = 1660,                          /* -nocpp */
  OPT_nodefaultlibs = 1661,                  /* -nodefaultlibs */
  OPT_nolibc = 1662,                         /* -nolibc */
  OPT_nophoboslib = 1663,                    /* -nophoboslib */
  OPT_nostartfiles = 1664,                   /* -nostartfiles */
  OPT_nostdinc = 1665,                       /* -nostdinc */
  OPT_nostdinc__ = 1666,                     /* -nostdinc++ */
  OPT_nostdlib = 1667,                       /* -nostdlib */
  OPT_o = 1668,                              /* -o */
  OPT_objects = 1669,                        /* -objects */
  OPT_p = 1670,                              /* -p */
  OPT_pass_exit_codes = 1671,                /* -pass-exit-codes */
  /* OPT_pedantic = 1672, */                 /* -pedantic */
  OPT_pedantic_errors = 1673,                /* -pedantic-errors */
  OPT_pg = 1674,                             /* -pg */
  OPT_pie = 1675,                            /* -pie */
  OPT_pipe = 1676,                           /* -pipe */
  OPT_posix = 1677,                          /* -posix */
  OPT_print_file_name_ = 1678,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1679,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1680,          /* -print-multi-directory */
  OPT_print_multi_lib = 1681,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1682,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1683,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1684,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1685,               /* -print-prog-name= */
  OPT_print_search_dirs = 1686,              /* -print-search-dirs */
  OPT_print_sysroot = 1687,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1688,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1689,                    /* -print-value */
  OPT_profile = 1690,                        /* -profile */
  OPT_pthread = 1691,                        /* -pthread */
  OPT_quiet = 1692,                          /* -quiet */
  OPT_r = 1693,                              /* -r */
  OPT_rdynamic = 1694,                       /* -rdynamic */
  OPT_remap = 1695,                          /* -remap */
  OPT_reverse_sort = 1696,                   /* -reverse-sort */
  OPT_s = 1697,                              /* -s */
  OPT_save_temps = 1698,                     /* -save-temps */
  OPT_save_temps_ = 1699,                    /* -save-temps= */
  OPT_shared = 1700,                         /* -shared */
  OPT_shared_libgcc = 1701,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1702,               /* -shared-libphobos */
  OPT_size_sort = 1703,                      /* -size-sort */
  /* OPT_specs = 1704, */                    /* -specs */
  OPT_specs_ = 1705,                         /* -specs= */
  OPT_static = 1706,                         /* -static */
  OPT_static_libasan = 1707,                 /* -static-libasan */
  OPT_static_libgcc = 1708,                  /* -static-libgcc */
  OPT_static_libgfortran = 1709,             /* -static-libgfortran */
  OPT_static_libgo = 1710,                   /* -static-libgo */
  OPT_static_liblsan = 1711,                 /* -static-liblsan */
  OPT_static_libmpx = 1712,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1713,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1714,               /* -static-libphobos */
  OPT_static_libstdc__ = 1715,               /* -static-libstdc++ */
  OPT_static_libtsan = 1716,                 /* -static-libtsan */
  OPT_static_libubsan = 1717,                /* -static-libubsan */
  OPT_static_pie = 1718,                     /* -static-pie */
  /* OPT_std_c__03 = 1719, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1720, */                /* -std=c++0x */
  OPT_std_c__11 = 1721,                      /* -std=c++11 */
  OPT_std_c__14 = 1722,                      /* -std=c++14 */
  OPT_std_c__17 = 1723,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1724, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1725, */                /* -std=c++1z */
  OPT_std_c__20 = 1726,                      /* -std=c++20 */
  /* OPT_std_c__2a = 1727, */                /* -std=c++2a */
  OPT_std_c__98 = 1728,                      /* -std=c++98 */
  OPT_std_c11 = 1729,                        /* -std=c11 */
  OPT_std_c17 = 1730,                        /* -std=c17 */
  /* OPT_std_c18 = 1731, */                  /* -std=c18 */
  /* OPT_std_c1x = 1732, */                  /* -std=c1x */
  OPT_std_c2x = 1733,                        /* -std=c2x */
  /* OPT_std_c89 = 1734, */                  /* -std=c89 */
  OPT_std_c90 = 1735,                        /* -std=c90 */
  OPT_std_c99 = 1736,                        /* -std=c99 */
  /* OPT_std_c9x = 1737, */                  /* -std=c9x */
  OPT_std_f2003 = 1738,                      /* -std=f2003 */
  OPT_std_f2008 = 1739,                      /* -std=f2008 */
  OPT_std_f2008ts = 1740,                    /* -std=f2008ts */
  OPT_std_f2018 = 1741,                      /* -std=f2018 */
  OPT_std_f95 = 1742,                        /* -std=f95 */
  OPT_std_gnu = 1743,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1744, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1745, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1746,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1747,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1748,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1749, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1750, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1751,                    /* -std=gnu++20 */
  /* OPT_std_gnu__2a = 1752, */              /* -std=gnu++2a */
  OPT_std_gnu__98 = 1753,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1754,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1755,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1756, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1757, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1758,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1759, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1760,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1761,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1762, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1763, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1764,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1765, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1766, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1767, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1768, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1769, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1770,                     /* -std=legacy */
  OPT_symbol_ = 1771,                        /* -symbol= */
  OPT_symbolic = 1772,                       /* -symbolic */
  OPT_t = 1773,                              /* -t */
  OPT_time = 1774,                           /* -time */
  OPT_time_ = 1775,                          /* -time= */
  OPT_traditional = 1776,                    /* -traditional */
  OPT_traditional_cpp = 1777,                /* -traditional-cpp */
  OPT_tree_stats = 1778,                     /* -tree-stats */
  OPT_trigraphs = 1779,                      /* -trigraphs */
  OPT_type_stats = 1780,                     /* -type-stats */
  OPT_u = 1781,                              /* -u */
  OPT_undef = 1782,                          /* -undef */
  OPT_v = 1783,                              /* -v */
  OPT_version = 1784,                        /* -version */
  OPT_w = 1785,                              /* -w */
  OPT_wrapper = 1786,                        /* -wrapper */
  OPT_x = 1787,                              /* -x */
  OPT_z = 1788,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
