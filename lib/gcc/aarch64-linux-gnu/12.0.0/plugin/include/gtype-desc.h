...
#define gt_ggc_m_28vec_unprocessed_thunk_va_gc_(X) do { \
  if (X != NULL) gt_ggc_mx_vec_unprocessed_thunk_va_gc_ (X);\
  } while (0)
...
#define gt_ggc_m_31vec_registered_function__va_gc_(X) do { \
  if (X != NULL) gt_ggc_mx_vec_registered_function__va_gc_ (X);\
  } while (0)
...
#define gt_ggc_m_34vec_omp_declare_target_attr_va_gc_(X) do { \
  if (X != NULL) gt_ggc_mx_vec_omp_declare_target_attr_va_gc_ (X);\
  } while (0)
...
#define gt_pch_n_28vec_unprocessed_thunk_va_gc_(X) do { \
  if (X != NULL) gt_pch_nx_vec_unprocessed_thunk_va_gc_ (X);\
  } while (0)
...
#define gt_pch_n_31vec_registered_function__va_gc_(X) do { \
  if (X != NULL) gt_pch_nx_vec_registered_function__va_gc_ (X);\
  } while (0)
...
#define gt_pch_n_34vec_omp_declare_target_attr_va_gc_(X) do { \
  if (X != NULL) gt_pch_nx_vec_omp_declare_target_attr_va_gc_ (X);\
  } while (0)
